...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(0.000000, -10.000000) * millimeter, vector(116.000000, -10.000000) * millimeter, vector(116.000000, 204.000000) * millimeter, vector(7.000000, 204.000000) * millimeter, vector(7.000000, 194.000000) * millimeter, vector(0.000000, 175.000000) * millimeter, vector(0.000000, -10.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(57.695521, 96.466559, 0.000000) * millimeter),
