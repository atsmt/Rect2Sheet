...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(80.882400, -40.000000) * millimeter, vector(80.882400, -50.000000) * millimeter, vector(192.647100, -50.000000) * millimeter, vector(192.647100, -40.000000) * millimeter, vector(200.000000, 0.000000) * millimeter, vector(220.000000, 0.000000) * millimeter, vector(220.000000, 120.000000) * millimeter, vector(0.000000, 120.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(112.114392, 42.093064, 0.000000) * millimeter),
