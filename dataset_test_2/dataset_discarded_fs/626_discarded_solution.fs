...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(120.000000, 0.000000) * millimeter, vector(120.000000, 80.000000) * millimeter, vector(65.122000, 120.000000) * millimeter, vector(65.122000, 130.000000) * millimeter, vector(3.393700, 130.000000) * millimeter, vector(3.393700, 120.000000) * millimeter, vector(0.000000, 80.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(55.836597, 58.970280, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(80.000000, 0.000000) * millimeter, vector(44.878000, -30.000000) * millimeter, vector(44.878000, -38.000000) * millimeter, vector(106.606300, -38.000000) * millimeter, vector(106.606300, -30.000000) * millimeter, vector(80.000000, 100.000000) * millimeter, vector(80.000000, 108.000000) * millimeter, vector(0.000000, 108.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1);
