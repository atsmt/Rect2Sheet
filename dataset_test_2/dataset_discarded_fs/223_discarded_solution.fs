...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0_0, "poly0_0", { "points" : [vector(-10.000000, 0.307700) * millimeter, vector(-20.000000, 0.307700) * millimeter, vector(-20.000000, 80.000000) * millimeter, vector(-10.000000, 80.000000) * millimeter, vector(0.000000, 95.000000) * millimeter, vector(120.000000, 95.000000) * millimeter, vector(120.000000, 0.000000) * millimeter, vector(83.076900, -10.000000) * millimeter, vector(83.076900, -20.000000) * millimeter, vector(36.923100, -20.000000) * millimeter, vector(36.923100, -10.000000) * millimeter, vector(0.000000, 0.000000) * millimeter, vector(-10.000000, 0.307700) * millimeter] });
        skSolve(sketch0_0);
        opExtractSurface(context, id + "surf0_0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0_0"), vector(51.894510, 41.873269, 0.000000) * millimeter),
        ...
        sheetMetalFlange(context, id + "flange0_0_1", {
            "edges" : qClosestTo(qOwnedByBody(qBodyType(qCreatedBy(id + "smStart0_0", EntityType.BODY), BodyType.SOLID), EntityType.EDGE), vector(-20.000000, 40.153850, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(-24.000000, -12.000000) * millimeter, vector(-160.000000, -12.000000) * millimeter, vector(-160.000000, 120.000000) * millimeter, vector(0.000000, 120.000000) * millimeter, vector(19.692300, -30.000000) * millimeter, vector(19.692300, -38.000000) * millimeter, vector(-60.000000, -38.000000) * millimeter, vector(-60.000000, -30.000000) * millimeter, vector(-24.000000, -12.000000) * millimeter] });
        skSolve(sketchRem1);
        sheetMetalTab(context, id + "smTab1", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem1"), vector(-20.000000, 40.153850, -5.000000) * millimeter),
            "booleanUnionScope" : qClosestTo(qCreatedBy(id + "flange0_0_1", EntityType.FACE), vector(-20.000000, 40.153850, -5.000000) * millimeter),
