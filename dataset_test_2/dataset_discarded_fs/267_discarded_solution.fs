...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(120.000000, 0.000000) * millimeter, vector(15.175700, -40.000004) * millimeter, vector(15.175700, -47.999973) * millimeter, vector(138.441000, -47.999973) * millimeter, vector(138.441000, -40.000004) * millimeter, vector(120.000000, 179.999989) * millimeter, vector(120.000000, 187.999958) * millimeter, vector(0.000000, 187.999958) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2);
