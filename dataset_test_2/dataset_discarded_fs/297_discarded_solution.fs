...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(169.000000, 0.000000) * millimeter, vector(169.000000, 113.000000) * millimeter, vector(113.000000, 113.000000) * millimeter, vector(113.000000, 123.000000) * millimeter, vector(0.000000, 123.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(82.935754, 59.935754, 0.000000) * millimeter),
