...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(200.000000, 0.000000) * millimeter, vector(220.146400, 161.464300) * millimeter, vector(224.909300, 170.257200) * millimeter, vector(195.396400, 186.243500) * millimeter, vector(190.633500, 177.450600) * millimeter, vector(200.000000, 160.000000) * millimeter, vector(129.756100, 190.000000) * millimeter, vector(129.756100, 200.000000) * millimeter, vector(54.634100, 200.000000) * millimeter, vector(54.634100, 190.000000) * millimeter, vector(0.000000, 160.000000) * millimeter, vector(-10.000000, 160.000000) * millimeter, vector(-10.000000, 0.000000) * millimeter, vector(200.000000, 0.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(100.974108, 93.792916, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem3, "polyRem3", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(-80.000000, 0.000000) * millimeter, vector(-80.000000, 139.999977) * millimeter, vector(0.000000, 139.999977) * millimeter, vector(40.000000, 42.447318) * millimeter, vector(48.000000, 42.447318) * millimeter, vector(48.000000, 8.882857) * millimeter, vector(40.000000, 8.882857) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem3);
