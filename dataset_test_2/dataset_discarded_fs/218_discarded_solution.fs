...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(36.923100, -20.000000) * millimeter, vector(36.923100, -28.000000) * millimeter, vector(83.076900, -28.000000) * millimeter, vector(83.076900, -20.000000) * millimeter, vector(120.000000, 0.000000) * millimeter, vector(120.000000, 100.000000) * millimeter, vector(130.000000, 16.792500) * millimeter, vector(140.000000, 14.792500) * millimeter, vector(140.000000, 104.000000) * millimeter, vector(130.000000, 106.000000) * millimeter, vector(0.000000, 100.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2);
