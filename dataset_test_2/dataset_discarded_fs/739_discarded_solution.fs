...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(208.254974, 53.512365, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(0.000000, 377.999964) * millimeter, vector(151.000000, 377.999964) * millimeter, vector(219.499900, -64.999980) * millimeter, vector(219.499900, -76.999939) * millimeter, vector(-57.894500, -76.999939) * millimeter, vector(-57.894500, -64.999980) * millimeter, vector(19.238041, -40.999283) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2);
        ...
        sheetMetalFlange(context, id + "flange2_3", {
            "edges" : qClosestTo(qOwnedByBody(qBodyType(qCreatedBy(id + "smStart0", EntityType.BODY), BodyType.SOLID), EntityType.EDGE), vector(170.802700, -75.000000, -0.000100) * millimeter),
            "angleControlType" : SMFlangeAngleControlType.BEND_ANGLE,
        ...
        var wallFace3 = qClosestTo(qCreatedBy(id + "flange2_3", EntityType.FACE), vector(170.802700, -75.000000, 4.999900) * millimeter);
        ...
        skPolyline(sketchRem3, "polyRem3", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(32.105500, -65.000100) * millimeter, vector(32.105500, -73.000100) * millimeter, vector(309.499900, -73.000100) * millimeter, vector(309.499900, -65.000100) * millimeter, vector(378.000000, 0.000000) * millimeter, vector(378.000000, 132.000000) * millimeter, vector(0.000000, 132.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem3);
        sheetMetalTab(context, id + "smTab3", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem3"), vector(170.802700, -75.000000, 75.000000) * millimeter),
