...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(0.000000, -20.000000) * millimeter, vector(72.500000, -20.000000) * millimeter, vector(72.500000, -10.000000) * millimeter, vector(100.000000, 0.000000) * millimeter, vector(130.000000, 0.000000) * millimeter, vector(130.000000, 70.000000) * millimeter, vector(0.000000, 70.000000) * millimeter, vector(0.000000, -20.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(38.686160, 28.401559, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(0.000000, -28.000000) * millimeter, vector(70.000000, -28.000000) * millimeter, vector(70.000000, 200.000000) * millimeter, vector(0.000000, 200.000000) * millimeter, vector(-10.000000, 80.000000) * millimeter, vector(-20.000000, 78.000000) * millimeter, vector(-20.000000, -17.384600) * millimeter, vector(-10.000000, -15.384600) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1);
        ...
        skPolyline(sketchRem2_0, "polyRem2_0", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(27.500000, -10.000000) * millimeter, vector(27.500000, -18.000000) * millimeter, vector(-45.000000, -18.000000) * millimeter, vector(-45.000000, 140.000000) * millimeter, vector(0.000000, 140.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        ...
        skPolyline(sketchRem2_1, "polyRem2_1", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(-45.000000, 0.000000) * millimeter, vector(-45.000000, 140.000000) * millimeter, vector(0.000000, 140.000000) * millimeter, vector(20.000000, -34.615400) * millimeter, vector(28.000000, -34.615400) * millimeter, vector(28.000000, -130.000000) * millimeter, vector(20.000000, -130.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2_1);
        sheetMetalTab(context, id + "smTab2_1", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem2_1"), vector(-25.000000, -20.000000, 62.307700) * millimeter),
            "booleanUnionScope" : qClosestTo(qCreatedBy(id + "flange1_2_1", EntityType.FACE), vector(-25.000000, -20.000000, 62.307700) * millimeter),
            "booleanOffset" : 0.0 * millimeter
        });
    });