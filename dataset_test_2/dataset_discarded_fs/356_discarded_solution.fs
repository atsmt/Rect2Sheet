...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(-70.000000, 0.000000) * millimeter, vector(-70.000000, -10.000000) * millimeter, vector(-170.000000, -10.000000) * millimeter, vector(-170.000000, 70.000000) * millimeter, vector(-134.000000, 100.000000) * millimeter, vector(-134.000000, 110.000000) * millimeter, vector(-106.000000, 110.000000) * millimeter, vector(-106.000000, 100.000000) * millimeter, vector(-70.000000, 70.000000) * millimeter, vector(200.000000, 70.000000) * millimeter, vector(200.000000, 0.000000) * millimeter, vector(-70.000000, 0.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(0.154639, 37.412371, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(-36.000000, -20.000000) * millimeter, vector(-36.000000, -28.000000) * millimeter, vector(-64.000000, -28.000000) * millimeter, vector(-64.000000, -20.000000) * millimeter, vector(-100.000000, 0.000000) * millimeter, vector(-100.000000, 200.000000) * millimeter, vector(0.000000, 200.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2);
