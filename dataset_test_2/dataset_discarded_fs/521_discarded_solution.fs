...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0_0, "poly0_0", { "points" : [vector(0.000000, 100.000000) * millimeter, vector(85.172400, 140.000000) * millimeter, vector(85.172400, 150.000000) * millimeter, vector(129.310300, 150.000000) * millimeter, vector(129.310300, 140.000000) * millimeter, vector(180.000000, 100.000000) * millimeter, vector(190.000000, 100.000000) * millimeter, vector(190.000000, 55.000000) * millimeter, vector(0.000000, 55.000000) * millimeter, vector(0.000000, 100.000000) * millimeter] });
        skSolve(sketch0_0);
        opExtractSurface(context, id + "surf0_0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0_0"), vector(96.026079, 92.506182, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem2b, "polyRem2b", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(15.172400, -10.000000) * millimeter, vector(17.172400, -20.000000) * millimeter, vector(61.310300, -20.000000) * millimeter, vector(59.310300, -10.000000) * millimeter, vector(80.000000, 0.000000) * millimeter, vector(118.000000, 0.000000) * millimeter, vector(118.000000, 70.000000) * millimeter, vector(0.000000, 70.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2b);
