...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(12.305700, -40.000000) * millimeter, vector(12.305700, -50.000000) * millimeter, vector(192.647100, -50.000000) * millimeter, vector(192.647100, -40.000000) * millimeter, vector(200.000000, 0.000000) * millimeter, vector(210.000000, 36.923100) * millimeter, vector(220.000000, 36.923100) * millimeter, vector(220.000000, 83.076900) * millimeter, vector(210.000000, 83.076900) * millimeter, vector(200.000000, 120.000000) * millimeter, vector(0.000000, 120.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(104.420848, 37.082849, 0.000000) * millimeter),
