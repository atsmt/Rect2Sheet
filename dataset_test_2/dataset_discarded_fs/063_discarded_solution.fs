...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0_0, "poly0_0", { "points" : [vector(0.000000, 110.000000) * millimeter, vector(200.000000, 110.000000) * millimeter, vector(200.000000, 45.000000) * millimeter, vector(0.000000, 45.000000) * millimeter, vector(0.000000, 110.000000) * millimeter] });
        skSolve(sketch0_0);
        opExtractSurface(context, id + "surf0_0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0_0"), vector(100.000000, 77.500000, 0.000000) * millimeter),
        ...
        sheetMetalFlange(context, id + "flange0_0_3_0_0_1a", {
            "edges" : qClosestTo(qOwnedByBody(qBodyType(qCreatedBy(id + "smStart0_0", EntityType.BODY), BodyType.SOLID), EntityType.EDGE), vector(100.000000, -10.000000, 0.000000) * millimeter),
        ...
        var wallFace3_0_0_1a = qClosestTo(qCreatedBy(id + "flange0_0_3_0_0_1a", EntityType.FACE), vector(100.000000, -7.000000, 4.000000) * millimeter);
        ...
        var sketchRem3_0_0_1a = newSketchOnPlane(context, id + "sketchRem3_0_0_1a", { "sketchPlane" : plane(vector(0.0, -4.0, 8.0) * millimeter, skN3_0_0_1a, vector(0.0, -0.6, -0.8)) });
        skPolyline(sketchRem3_0_0_1a, "polyRem3_0_0_1a", { "points" : [vector(8.000000, 0.000000) * millimeter, vector(8.000000, 200.000000) * millimeter, vector(-188.000000, 200.000000) * millimeter, vector(-188.000000, 0.000000) * millimeter, vector(8.000000, 0.000000) * millimeter] });
        skSolve(sketchRem3_0_0_1a);
        sheetMetalTab(context, id + "smTab3_0_0_1a", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem3_0_0_1a"), vector(0.000000, -7.000000, 4.000000) * millimeter),
        ...
        skPolyline(sketchRem1b, "polyRem1b", { "points" : [vector(0.000000, -28.000000) * millimeter, vector(200.000000, -28.000000) * millimeter, vector(200.000000, 128.000000) * millimeter, vector(0.000000, 128.000000) * millimeter, vector(0.000000, -28.000000) * millimeter] });
        skSolve(sketchRem1b);
