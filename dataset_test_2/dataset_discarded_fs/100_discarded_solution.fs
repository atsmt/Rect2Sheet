...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0_0, "poly0_0", { "points" : [vector(-125.000000, 72.000000) * millimeter, vector(-135.000000, 72.000000) * millimeter, vector(-135.000000, 128.000000) * millimeter, vector(-125.000000, 128.000000) * millimeter, vector(-105.000000, 200.000000) * millimeter, vector(-125.000000, 202.692300) * millimeter, vector(-135.000000, 202.692300) * millimeter, vector(-135.000000, 249.659500) * millimeter, vector(-125.000000, 249.659500) * millimeter, vector(-10.000000, 200.000000) * millimeter, vector(-10.000000, 0.000000) * millimeter, vector(-105.000000, 0.000000) * millimeter, vector(-125.000000, 72.000000) * millimeter] });
        skSolve(sketch0_0);
        opExtractSurface(context, id + "surf0_0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0_0"), vector(35.748701, 115.317909, 0.000000) * millimeter),
        ...
        sheetMetalFlange(context, id + "flange0_1_2", {
            "edges" : qClosestTo(qOwnedByBody(qBodyType(qCreatedBy(id + "smStart0_0", EntityType.BODY), BodyType.SOLID), EntityType.EDGE), vector(-30.000000, 226.175900, 0.000000) * millimeter),
            "angleControlType" : SMFlangeAngleControlType.BEND_ANGLE,
            "bendAngle" : 90.000000 * degree,
            "limitType" : SMFlangeBoundingType.BLIND,
            "distance" : 10.000000 * millimeter,
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(-70.000000, -20.340500) * millimeter, vector(-78.000000, -20.340500) * millimeter, vector(-78.000000, -67.307700) * millimeter, vector(-70.000000, -67.307700) * millimeter, vector(70.000000, 0.000000) * millimeter, vector(70.000000, 80.000000) * millimeter, vector(0.000000, 80.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2);
        sheetMetalTab(context, id + "smTab2", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem2"), vector(-30.000000, 226.175900, -5.000000) * millimeter),
            "booleanUnionScope" : qClosestTo(qCreatedBy(id + "flange0_1_2", EntityType.FACE), vector(-30.000000, 226.175900, -5.000000) * millimeter),
            "booleanOffset" : 0.0 * millimeter
        });
    });