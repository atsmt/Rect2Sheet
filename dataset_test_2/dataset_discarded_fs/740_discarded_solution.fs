...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(143.999800, -73.000072) * millimeter, vector(143.999800, -76.999939) * millimeter, vector(-78.010400, -76.999939) * millimeter, vector(-78.010400, -64.999980) * millimeter, vector(0.000000, 377.999964) * millimeter, vector(151.000000, 377.999964) * millimeter, vector(151.000000, 0.000000) * millimeter, vector(144.000100, -65.000070) * millimeter, vector(143.999800, -73.000072) * millimeter] });
        skSolve(sketchRem2);
