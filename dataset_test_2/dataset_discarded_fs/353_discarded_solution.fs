...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(-44.800000, 100.000000) * millimeter, vector(-44.800000, 110.000000) * millimeter, vector(-13.030800, 110.000000) * millimeter, vector(-13.030800, 100.000000) * millimeter, vector(0.000000, 70.000000) * millimeter, vector(200.000000, 70.000000) * millimeter, vector(200.000000, 0.000000) * millimeter, vector(0.000000, 0.000000) * millimeter, vector(-44.800000, 100.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(83.008988, 40.037294, 0.000000) * millimeter),
