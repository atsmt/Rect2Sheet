...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(187.782159, 51.274924, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(-75.610088, -62.999987) * millimeter, vector(0.000000, 377.999964) * millimeter, vector(151.000000, 377.999964) * millimeter, vector(395.682100, -9.224173) * millimeter, vector(403.948300, -16.851737) * millimeter, vector(378.091400, -54.832384) * millimeter, vector(369.825200, -47.204867) * millimeter, vector(151.000000, 0.000000) * millimeter, vector(144.000100, -65.000070) * millimeter, vector(144.000100, -73.000072) * millimeter, vector(30.499900, -73.000072) * millimeter, vector(30.499900, -65.000070) * millimeter, vector(0.000000, 0.000000) * millimeter, vector(-75.610088, -62.999987) * millimeter] });
        skSolve(sketchRem2);
        ...
        sheetMetalFlange(context, id + "flange2_3", {
            "edges" : qClosestTo(qOwnedByBody(qBodyType(qCreatedBy(id + "smStart0", EntityType.BODY), BodyType.SOLID), EntityType.EDGE), vector(122.994700, -75.000000, -0.000100) * millimeter),
            "angleControlType" : SMFlangeAngleControlType.BEND_ANGLE,
        ...
        var wallFace3 = qClosestTo(qCreatedBy(id + "flange2_3", EntityType.FACE), vector(122.994700, -75.000000, 4.999900) * millimeter);
        ...
        skPolyline(sketchRem3, "polyRem3", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(11.989600, -65.000100) * millimeter, vector(11.989600, -73.000100) * millimeter, vector(233.999800, -73.000100) * millimeter, vector(233.999800, -65.000100) * millimeter, vector(378.000000, 0.000000) * millimeter, vector(378.000000, 132.000000) * millimeter, vector(0.000000, 132.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem3);
        sheetMetalTab(context, id + "smTab3", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem3"), vector(122.994700, -75.000000, 75.000000) * millimeter),
