...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(172.000000, 0.000000) * millimeter, vector(223.000000, 147.000000) * millimeter, vector(233.000000, 147.000000) * millimeter, vector(233.000000, 204.682000) * millimeter, vector(223.000000, 204.682000) * millimeter, vector(172.000000, 197.000000) * millimeter, vector(172.000000, 233.000000) * millimeter, vector(0.000000, 233.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(69.544395, 119.102013, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(0.000000, -59.000000) * millimeter, vector(172.000000, -59.000000) * millimeter, vector(172.000000, 147.000000) * millimeter, vector(0.000000, 147.000000) * millimeter, vector(-10.000000, 145.000000) * millimeter, vector(-10.000000, -2.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1);
        ...
        skPolyline(sketchRem3b, "polyRem3b", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(180.000000, 0.000000) * millimeter, vector(180.000000, 86.000000) * millimeter, vector(0.000000, 86.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem3b);
