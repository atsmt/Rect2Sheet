...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(393.000000, 0.000000) * millimeter, vector(393.000000, 191.000000) * millimeter, vector(383.000000, 191.000000) * millimeter, vector(-47.000000, 253.134400) * millimeter, vector(-57.000000, 253.134400) * millimeter, vector(-57.000000, 221.176500) * millimeter, vector(-47.000000, 221.176500) * millimeter, vector(0.000000, 191.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(182.232923, 112.798988, 0.000000) * millimeter),
