...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(0.000000, -46.000000) * millimeter, vector(85.000000, -46.000000) * millimeter, vector(85.000000, 85.000000) * millimeter, vector(58.846200, 99.000000) * millimeter, vector(58.846200, 107.000000) * millimeter, vector(26.153800, 107.000000) * millimeter, vector(26.153800, 99.000000) * millimeter, vector(0.000000, 85.000000) * millimeter, vector(-14.000000, 107.153800) * millimeter, vector(-24.000000, 105.153800) * millimeter, vector(-24.000000, 76.153800) * millimeter, vector(-14.000000, 78.153800) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1);
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(26.153800, -26.000000) * millimeter, vector(26.153800, -34.000000) * millimeter, vector(58.846200, -34.000000) * millimeter, vector(58.846200, -26.000000) * millimeter, vector(85.000000, 0.000000) * millimeter, vector(85.000000, 85.000000) * millimeter, vector(0.000000, 85.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2);
