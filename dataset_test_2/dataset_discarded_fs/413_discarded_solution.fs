...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(0.000000, 200.000000) * millimeter, vector(0.000000, 380.000000) * millimeter, vector(100.000000, 380.000000) * millimeter, vector(140.000000, 329.310300) * millimeter, vector(150.000000, 329.310300) * millimeter, vector(150.000000, 267.931000) * millimeter, vector(140.000000, 267.931000) * millimeter, vector(100.000000, 200.000000) * millimeter, vector(0.000000, 200.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(66.228792, 290.967995, 0.000000) * millimeter),
