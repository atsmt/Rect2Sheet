...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(200.000000, 0.000000) * millimeter, vector(200.000000, 170.000000) * millimeter, vector(0.000000, 170.000000) * millimeter, vector(0.000000, 160.000000) * millimeter, vector(-38.117600, -10.000000) * millimeter, vector(-38.117600, -20.000000) * millimeter, vector(-12.413800, -20.000000) * millimeter, vector(-12.413800, -10.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(110.442133, 81.147613, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem1_0_1a, "polyRem1_0_1a", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(8.000000, 0.000000) * millimeter, vector(8.000000, 200.000000) * millimeter, vector(0.000000, 200.000000) * millimeter, vector(-90.000000, -40.000000) * millimeter, vector(-88.000000, -50.000000) * millimeter, vector(-18.000000, -50.000000) * millimeter, vector(-20.000000, -40.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        ...
        sheetMetalFlange(context, id + "flange1_0_1_1b", {
            "edges" : qClosestTo(qOwnedByBody(qBodyType(qCreatedBy(id + "smStart0", EntityType.BODY), BodyType.SOLID), EntityType.EDGE), vector(-50.000000, 170.000000, 65.000000) * millimeter),
            "angleControlType" : SMFlangeAngleControlType.BEND_ANGLE,
            "bendAngle" : 90.000000 * degree,
            "limitType" : SMFlangeBoundingType.BLIND,
            "distance" : 10.000000 * millimeter,
        ...
        skPolyline(sketchRem1b, "polyRem1b", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(158.000000, 0.000000) * millimeter, vector(158.000000, 70.000000) * millimeter, vector(0.000000, 70.000000) * millimeter, vector(-20.000000, 99.117600) * millimeter, vector(-28.000000, 99.117600) * millimeter, vector(-28.000000, 5.294100) * millimeter, vector(-20.000000, 5.294100) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1b);
        sheetMetalTab(context, id + "smTab1b", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem1b"), vector(-50.000000, 165.000000, 65.000000) * millimeter),
            "booleanUnionScope" : qClosestTo(qCreatedBy(id + "flange1_0_1_1b", EntityType.FACE), vector(-50.000000, 165.000000, 65.000000) * millimeter),
            "booleanOffset" : 0.0 * millimeter
        });
