...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem3, "polyRem3", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(-12.000000, -10.000000) * millimeter, vector(-12.000000, -18.000000) * millimeter, vector(116.000000, -18.000000) * millimeter, vector(116.000000, -10.000000) * millimeter, vector(180.000000, 0.000000) * millimeter, vector(180.000000, 200.000000) * millimeter, vector(0.000000, 200.000000) * millimeter, vector(-20.000000, 196.000000) * millimeter, vector(-20.000000, 4.000000) * millimeter, vector(-10.000000, 6.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem3);
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(120.000000, 0.000000) * millimeter, vector(150.000000, -24.000000) * millimeter, vector(158.000000, -24.000000) * millimeter, vector(158.000000, 168.000000) * millimeter, vector(150.000000, 168.000000) * millimeter, vector(120.000000, 160.000000) * millimeter, vector(0.000000, 160.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2);
