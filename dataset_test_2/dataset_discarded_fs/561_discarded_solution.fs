...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(-60.000000, 0.000000) * millimeter, vector(-230.000000, 0.000000) * millimeter, vector(-230.000000, 140.000000) * millimeter, vector(-220.000000, 140.000000) * millimeter, vector(-137.241400, 150.000000) * millimeter, vector(-137.241400, 160.000000) * millimeter, vector(-24.137900, 160.000000) * millimeter, vector(-24.137900, 150.000000) * millimeter, vector(-60.000000, 140.000000) * millimeter, vector(-60.000000, 0.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(-140.522545, 77.535626, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem3, "polyRem3", { "points" : [vector(-203.261253, -55.018848) * millimeter, vector(-220.000000, -59.549700) * millimeter, vector(-228.000000, -59.549700) * millimeter, vector(-228.000000, -5.338100) * millimeter, vector(-220.000000, -5.338100) * millimeter, vector(-198.054172, -2.409374) * millimeter, vector(-180.000000, 180.000000) * millimeter, vector(0.000000, 180.000000) * millimeter, vector(0.000000, 0.000000) * millimeter, vector(-185.970633, -50.338615) * millimeter, vector(-220.000000, -337.241400) * millimeter, vector(-232.000000, -337.241400) * millimeter, vector(-232.000000, -224.137900) * millimeter, vector(-220.000000, -224.137900) * millimeter, vector(-203.261253, -55.018848) * millimeter] });
        skSolve(sketchRem3);
