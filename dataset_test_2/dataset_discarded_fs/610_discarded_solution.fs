...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(0.000000, -46.000000) * millimeter, vector(85.000000, -46.000000) * millimeter, vector(85.000000, 107.000000) * millimeter, vector(0.000000, 107.000000) * millimeter, vector(0.000000, -46.000000) * millimeter] });
        skSolve(sketchRem1);
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(0.000000, -34.000000) * millimeter, vector(85.000000, -34.000000) * millimeter, vector(85.000000, 0.000000) * millimeter, vector(99.000000, 0.000000) * millimeter, vector(109.000000, -2.000000) * millimeter, vector(109.000000, 83.000000) * millimeter, vector(99.000000, 85.000000) * millimeter, vector(0.000000, 85.000000) * millimeter, vector(0.000000, -34.000000) * millimeter] });
        skSolve(sketchRem2);
