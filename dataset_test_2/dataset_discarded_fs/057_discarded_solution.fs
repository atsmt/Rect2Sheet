...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(0.000000, -10.000000) * millimeter, vector(200.000000, -10.000000) * millimeter, vector(200.000000, 80.000000) * millimeter, vector(100.000000, 100.000000) * millimeter, vector(100.000000, 110.000000) * millimeter, vector(47.500000, 110.000000) * millimeter, vector(47.500000, 100.000000) * millimeter, vector(0.000000, 80.000000) * millimeter, vector(0.000000, -10.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(101.922506, 43.109660, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem1_1, "polyRem1_1", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(-47.500000, -20.000000) * millimeter, vector(-47.500000, -28.000000) * millimeter, vector(-100.000000, -28.000000) * millimeter, vector(-100.000000, -20.000000) * millimeter, vector(-95.000000, 0.000000) * millimeter, vector(-95.000000, 120.000000) * millimeter, vector(0.000000, 120.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
