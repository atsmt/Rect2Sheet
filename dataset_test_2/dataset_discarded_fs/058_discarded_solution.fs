...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(0.000000, -10.000000) * millimeter, vector(200.000000, -10.000000) * millimeter, vector(200.000000, 80.000000) * millimeter, vector(152.500000, 100.000000) * millimeter, vector(152.500000, 110.000000) * millimeter, vector(100.000000, 110.000000) * millimeter, vector(100.000000, 100.000000) * millimeter, vector(0.000000, 80.000000) * millimeter, vector(0.000000, -10.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(98.077494, 43.109660, 0.000000) * millimeter),
