...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0_0, "poly0_0", { "points" : [vector(0.000000, 175.000000) * millimeter, vector(19.500000, 194.000000) * millimeter, vector(19.500000, 204.000000) * millimeter, vector(52.862300, 204.000000) * millimeter, vector(52.862300, 194.000000) * millimeter, vector(53.000000, 175.000000) * millimeter, vector(53.000000, 0.000000) * millimeter, vector(0.000000, 0.000000) * millimeter, vector(0.000000, 175.000000) * millimeter] });
        skSolve(sketch0_0);
        opExtractSurface(context, id + "surf0_0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0_0"), vector(90.161636, 98.641081, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(-89.684211, -12.000000) * millimeter, vector(-82.500000, -19.000000) * millimeter, vector(-82.500000, -27.000000) * millimeter, vector(-115.862300, -27.000000) * millimeter, vector(-115.862300, -19.000000) * millimeter, vector(-102.000000, 262.000000) * millimeter, vector(0.000000, 262.000000) * millimeter, vector(0.000000, -12.000000) * millimeter, vector(-89.684211, -12.000000) * millimeter] });
        skSolve(sketchRem1);
