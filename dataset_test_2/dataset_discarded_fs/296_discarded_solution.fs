...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(113.000000, 0.000000) * millimeter, vector(113.000000, 123.000000) * millimeter, vector(0.000000, 123.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(56.500000, 61.500000, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem3, "polyRem3", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(0.000000, -256.118577) * millimeter, vector(-2.000000, -266.118567) * millimeter, vector(111.000000, -266.118567) * millimeter, vector(113.000000, -256.118577) * millimeter, vector(113.000000, 198.000021) * millimeter, vector(0.000000, 198.000021) * millimeter, vector(-18.000000, 108.899453) * millimeter, vector(-26.000000, 108.899453) * millimeter, vector(-26.000000, -1.719550) * millimeter, vector(-18.000000, -1.719550) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem3);
        ...
        // Flange 3->1: bend=96.44deg, zone=10mm
        ...
        var wallFace1 = qClosestTo(qCreatedBy(id + "flange3_1", EntityType.FACE), vector(134.019318, 56.500000, 55.786604) * millimeter);
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(0.000000, -96.846700) * millimeter, vector(113.000000, -96.846700) * millimeter, vector(113.000000, 226.000091) * millimeter, vector(0.000000, 226.000091) * millimeter, vector(0.000000, -96.846700) * millimeter] });
        skSolve(sketchRem1);
        sheetMetalTab(context, id + "smTab1", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem1"), vector(183.874776, 56.500000, -23.722115) * millimeter),
