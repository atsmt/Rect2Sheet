...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem3, "polyRem3", { "points" : [vector(-266.063812, -41.699896) * millimeter, vector(-370.065700, -58.000000) * millimeter, vector(-370.065700, -70.000000) * millimeter, vector(-541.445200, -70.000000) * millimeter, vector(-541.445200, -58.000000) * millimeter, vector(-244.635066, -19.439864) * millimeter, vector(-95.000000, 136.000000) * millimeter, vector(0.000000, 136.000000) * millimeter, vector(0.000000, 0.000000) * millimeter, vector(-126.040199, -19.754145) * millimeter, vector(-186.136900, -58.000000) * millimeter, vector(-186.136900, -66.000000) * millimeter, vector(-281.755200, -66.000000) * millimeter, vector(-281.755200, -58.000000) * millimeter, vector(-266.063812, -41.699896) * millimeter] });
        skSolve(sketchRem3);
