...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(200.000000, 0.000000) * millimeter, vector(200.000000, 160.000000) * millimeter, vector(201.862200, 171.368400) * millimeter, vector(206.625100, 180.161300) * millimeter, vector(114.026600, 230.319200) * millimeter, vector(109.263800, 221.526300) * millimeter, vector(0.000000, 160.000000) * millimeter, vector(-30.000000, 160.000000) * millimeter, vector(-30.000000, 0.000000) * millimeter, vector(200.000000, 0.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(90.317120, 98.067392, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(0.000000, -48.000000) * millimeter, vector(160.000000, -48.000000) * millimeter, vector(160.000000, 80.000000) * millimeter, vector(-30.000000, 80.000000) * millimeter, vector(-40.000000, 78.000000) * millimeter, vector(-40.000000, -2.000000) * millimeter, vector(-30.000000, 0.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1);
