...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem2b, "polyRem2b", { "points" : [vector(-458.000000, 0.000000) * millimeter, vector(-458.000000, 250.000000) * millimeter, vector(8.000000, 250.000000) * millimeter, vector(8.000000, 0.000000) * millimeter, vector(-458.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2b);
