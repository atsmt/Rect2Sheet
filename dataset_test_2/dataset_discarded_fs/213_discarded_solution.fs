...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(210.000000, 0.000000) * millimeter, vector(210.000000, 160.000000) * millimeter, vector(-10.000000, 160.000000) * millimeter, vector(-10.000000, 0.000000) * millimeter, vector(210.000000, 0.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(100.000000, 80.000000, 0.000000) * millimeter),
        ...
        // === Child Tab 2_0 from 0 (two_bend) ===
        // Flange 0->1_0_2_0: bend=90.00deg, zone=10mm
        sheetMetalFlange(context, id + "flange0_1_0_2_0a", {
        ...
        // Remaining polygon for tab 1_0_2_0
        var sketchRem1_0_2_0a = newSketchOnPlane(context, id + "sketchRem1_0_2_0a", { "sketchPlane" : plane(vector(210.0, 0.0, -10.0) * millimeter, vector(-1.0, 0.0, 0.0), vector(0.0, 0.0, 1.0)) });
        skPolyline(sketchRem1_0_2_0a, "polyRem1_0_2_0a", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(8.000000, 0.000000) * millimeter, vector(8.000000, 160.000000) * millimeter, vector(0.000000, 160.000000) * millimeter, vector(-179.622300, 348.812500) * millimeter, vector(-186.654900, 344.521600) * millimeter, vector(-135.163700, 236.130400) * millimeter, vector(-128.131100, 240.421300) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1_0_2_0a);
        sheetMetalTab(context, id + "smTab1_0_2_0a", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem1_0_2_0a"), vector(210.000000, 80.000000, -5.000000) * millimeter),
            "booleanUnionScope" : qClosestTo(qCreatedBy(id + "flange0_1_0_2_0a", EntityType.FACE), vector(210.000000, 80.000000, -5.000000) * millimeter),
            "booleanOffset" : 0.0 * millimeter
        });
        // Flange 1_0_2_0->2_0: bend=90.00deg, zone=10mm
        sheetMetalFlange(context, id + "flange1_0_2_0_2_0b", {
        ...
        var sketchRem2_0b = newSketchOnPlane(context, id + "sketchRem2_0b", { "sketchPlane" : plane(vector(105.0, 236.1304, -147.1637) * millimeter, vector(0.0, 0.4290933942, 0.9032601281), vector(1.0, 0.0, 0.0)) });
        ...
        sheetMetalTab(context, id + "smTab2_0b", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem2_0b"), vector(205.000000, 290.326000, -172.909300) * millimeter),
            "booleanUnionScope" : qClosestTo(qCreatedBy(id + "flange1_0_2_0_2_0b", EntityType.FACE), vector(205.000000, 290.326000, -172.909300) * millimeter),
            "booleanOffset" : 0.0 * millimeter
        });
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(200.000000, 0.000000) * millimeter, vector(200.000000, 80.000000) * millimeter, vector(144.667000, 90.000000) * millimeter, vector(146.667000, 100.000000) * millimeter, vector(28.283200, 100.000000) * millimeter, vector(26.283200, 90.000000) * millimeter, vector(0.000000, 80.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1);
