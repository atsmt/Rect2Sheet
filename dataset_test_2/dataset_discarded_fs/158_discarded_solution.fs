...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(0.000000, -10.000000) * millimeter, vector(379.000000, -10.000000) * millimeter, vector(379.000000, 147.000000) * millimeter, vector(278.676500, 200.000000) * millimeter, vector(278.676500, 210.000000) * millimeter, vector(100.323500, 210.000000) * millimeter, vector(100.323500, 200.000000) * millimeter, vector(0.000000, 147.000000) * millimeter, vector(0.000000, -10.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(189.500000, 91.473988, 0.000000) * millimeter),
