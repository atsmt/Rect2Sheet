...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(-21.176500, -20.000000) * millimeter, vector(-21.176500, -28.000000) * millimeter, vector(-58.823500, -28.000000) * millimeter, vector(-58.823500, -20.000000) * millimeter, vector(-80.000000, 0.000000) * millimeter, vector(-80.000000, 160.000000) * millimeter, vector(0.000000, 160.000000) * millimeter, vector(10.000000, 162.000000) * millimeter, vector(10.000000, 2.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2);
        ...
        sheetMetalFlange(context, id + "flange2_1_2_3a", {
            "edges" : qClosestTo(qOwnedByBody(qBodyType(qCreatedBy(id + "smStart0", EntityType.BODY), BodyType.SOLID), EntityType.EDGE), vector(140.000000, -130.000000, -150.000000) * millimeter),
            "angleControlType" : SMFlangeAngleControlType.BEND_ANGLE,
            "bendAngle" : 90.000000 * degree,
            "limitType" : SMFlangeBoundingType.BLIND,
            "distance" : 10.000000 * millimeter,
        ...
        var sketchRem1_2_3a = newSketchOnPlane(context, id + "sketchRem1_2_3a", { "sketchPlane" : plane(vector(140.0, -50.0, -140.0) * millimeter, vector(-1.0, 0.0, 0.0), vector(0.0, 0.0, -1.0)) });
        ...
        sheetMetalTab(context, id + "smTab1_2_3a", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem1_2_3a"), vector(140.000000, -130.000000, -145.000000) * millimeter),
            "booleanUnionScope" : qClosestTo(qCreatedBy(id + "flange2_1_2_3a", EntityType.FACE), vector(140.000000, -130.000000, -145.000000) * millimeter),
            "booleanOffset" : 0.0 * millimeter
        });
        // Flange 1_2_3->3: bend=90.00deg, zone=10mm
        sheetMetalFlange(context, id + "flange1_2_3_3b", {
            "edges" : qClosestTo(qOwnedByBody(qBodyType(qCreatedBy(id + "smStart0", EntityType.BODY), BodyType.SOLID), EntityType.EDGE), vector(140.000000, -10.000000, -65.000000) * millimeter),
            "angleControlType" : SMFlangeAngleControlType.BEND_ANGLE,
            "bendAngle" : 90.000000 * degree,
            "limitType" : SMFlangeBoundingType.BLIND,
            "distance" : 10.000000 * millimeter,
        ...
        skPolyline(sketchRem3b, "polyRem3b", { "points" : [vector(-80.000000, 0.000000) * millimeter, vector(-80.000000, 70.000000) * millimeter, vector(8.000000, 70.000000) * millimeter, vector(8.000000, 0.000000) * millimeter, vector(-80.000000, 0.000000) * millimeter] });
        skSolve(sketchRem3b);
        sheetMetalTab(context, id + "smTab3b", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem3b"), vector(135.000000, -10.000000, -65.000000) * millimeter),
            "booleanUnionScope" : qClosestTo(qCreatedBy(id + "flange1_2_3_3b", EntityType.FACE), vector(135.000000, -10.000000, -65.000000) * millimeter),
            "booleanOffset" : 0.0 * millimeter
        });
    });