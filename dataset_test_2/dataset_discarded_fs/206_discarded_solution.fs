...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem1_1b, "polyRem1_1b", { "points" : [vector(-200.000000, 0.000000) * millimeter, vector(-200.000000, 35.000000) * millimeter, vector(-144.667000, 45.000000) * millimeter, vector(-142.667000, 55.000000) * millimeter, vector(-53.333000, 55.000000) * millimeter, vector(-55.333000, 45.000000) * millimeter, vector(0.000000, 35.000000) * millimeter, vector(8.000000, 35.000000) * millimeter, vector(8.000000, 0.000000) * millimeter, vector(-200.000000, 0.000000) * millimeter] });
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(55.333000, -29.999996) * millimeter, vector(55.333000, -37.999980) * millimeter, vector(144.667000, -37.999980) * millimeter, vector(144.667000, -29.999996) * millimeter, vector(200.000000, 0.000000) * millimeter, vector(200.000000, 119.999983) * millimeter, vector(0.000000, 119.999983) * millimeter, vector(-10.000000, 117.999983) * millimeter, vector(-10.000000, -2.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2);
        ...
        var wallFace1_0 = qClosestTo(qCreatedBy(id + "flange2_1_0", EntityType.FACE), vector(205.000000, 200.000000, -47.500000) * millimeter);
        ...
        skPolyline(sketchRem1_0, "polyRem1_0", { "points" : [vector(200.000000, 0.000000) * millimeter, vector(200.000000, 35.000000) * millimeter, vector(-12.000000, 35.000000) * millimeter, vector(-12.000000, 0.000000) * millimeter, vector(200.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1_0);
        sheetMetalTab(context, id + "smTab1_0", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem1_0"), vector(205.000000, 200.000000, -30.000000) * millimeter),
