...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem3, "polyRem3", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(-160.000000, 0.000000) * millimeter, vector(-180.000000, -2.647100) * millimeter, vector(-188.000000, -2.647100) * millimeter, vector(-188.000000, 109.117600) * millimeter, vector(-180.000000, 109.117600) * millimeter, vector(-160.000000, 80.000000) * millimeter, vector(0.000000, 80.000000) * millimeter, vector(30.000000, 21.463400) * millimeter, vector(38.000000, 21.463400) * millimeter, vector(38.000000, -54.634100) * millimeter, vector(30.000000, -54.634100) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem3);
        ...
        sheetMetalFlange(context, id + "flange3_2", {
            "edges" : qClosestTo(qOwnedByBody(qBodyType(qCreatedBy(id + "smStart0", EntityType.BODY), BodyType.SOLID), EntityType.EDGE), vector(206.585350, -50.000000, -230.000000) * millimeter),
            "angleControlType" : SMFlangeAngleControlType.BEND_ANGLE,
            "bendAngle" : 90.000000 * degree,
            "limitType" : SMFlangeBoundingType.BLIND,
            "distance" : 10.000000 * millimeter,
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(120.000000, 0.000000) * millimeter, vector(160.000000, -91.463400) * millimeter, vector(168.000000, -91.463400) * millimeter, vector(168.000000, -15.365900) * millimeter, vector(160.000000, -15.365900) * millimeter, vector(120.000000, 70.000000) * millimeter, vector(0.000000, 70.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2);
        sheetMetalTab(context, id + "smTab2", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem2"), vector(206.585350, -45.000000, -230.000000) * millimeter),
            "booleanUnionScope" : qClosestTo(qCreatedBy(id + "flange3_2", EntityType.FACE), vector(206.585350, -45.000000, -230.000000) * millimeter),
            "booleanOffset" : 0.0 * millimeter
        });
    });