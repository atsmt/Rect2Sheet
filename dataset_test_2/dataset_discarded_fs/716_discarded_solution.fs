...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem2b, "polyRem2b", { "points" : [vector(17.950280, -8.000000) * millimeter, vector(89.751400, -40.000000) * millimeter, vector(89.751400, -52.000000) * millimeter, vector(-9.615400, -52.000000) * millimeter, vector(-9.615400, -40.000000) * millimeter, vector(0.000000, 140.000000) * millimeter, vector(80.000000, 140.000000) * millimeter, vector(80.000000, -8.000000) * millimeter, vector(17.950280, -8.000000) * millimeter] });
        skSolve(sketchRem2b);
