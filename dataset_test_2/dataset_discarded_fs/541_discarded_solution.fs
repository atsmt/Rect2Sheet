...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(393.000000, 0.000000) * millimeter, vector(393.000000, 191.000000) * millimeter, vector(383.000000, 191.000000) * millimeter, vector(-47.000000, 299.922400) * millimeter, vector(-57.000000, 299.922400) * millimeter, vector(-57.000000, 193.246800) * millimeter, vector(-47.000000, 193.246800) * millimeter, vector(0.000000, 191.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(170.380227, 128.092477, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem1b, "polyRem1b", { "points" : [vector(-383.000000, 0.000000) * millimeter, vector(-383.000000, 307.000000) * millimeter, vector(8.000000, 307.000000) * millimeter, vector(8.000000, 0.000000) * millimeter, vector(-383.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1b);
