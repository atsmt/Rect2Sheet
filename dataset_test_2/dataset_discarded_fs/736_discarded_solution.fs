...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(44.421500, -27.000059) * millimeter, vector(44.421500, -34.999998) * millimeter, vector(106.578500, -34.999998) * millimeter, vector(106.578500, -27.000059) * millimeter, vector(151.000000, 0.000000) * millimeter, vector(151.000000, 132.000018) * millimeter, vector(0.000000, 132.000018) * millimeter, vector(-91.725100, 34.518203) * millimeter, vector(-101.061700, 28.936502) * millimeter, vector(-84.605000, -13.962051) * millimeter, vector(-75.268400, -8.380369) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1);
        ...
        // Flange 1->2: bend=74.86deg, zone=10mm
        ...
        var wallFace2 = qClosestTo(qCreatedBy(id + "flange1_2", EntityType.FACE), vector(476.886739, -94.052539, -39.629737) * millimeter);
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(30.500100, -64.999980) * millimeter, vector(32.153344, -76.125454) * millimeter, vector(145.653044, -76.125454) * millimeter, vector(143.999800, -64.999980) * millimeter, vector(151.000000, 0.000000) * millimeter, vector(369.825200, -47.204867) * millimeter, vector(376.438156, -51.706870) * millimeter, vector(402.295056, -13.726222) * millimeter, vector(395.682100, -9.224173) * millimeter, vector(151.000000, 377.999964) * millimeter, vector(0.000000, 377.999964) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2);
        sheetMetalTab(context, id + "smTab2", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem2"), vector(476.886739, -107.496812, -67.594094) * millimeter),
            "booleanUnionScope" : wallFace2,
            "booleanOffset" : 0.0 * millimeter
        });

        // === Child Tab 3 from 2 (one_bend) ===
        // Flange 2->3: bend=154.32deg, zone=10mm
