...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(0.000000, 200.000000) * millimeter, vector(0.000000, 380.000000) * millimeter, vector(100.000000, 380.000000) * millimeter, vector(140.000000, 354.137900) * millimeter, vector(150.000000, 354.137900) * millimeter, vector(150.000000, 243.103400) * millimeter, vector(140.000000, 243.103400) * millimeter, vector(100.000000, 200.000000) * millimeter, vector(0.000000, 200.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(70.205165, 291.310784, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(-4.137900, -10.000000) * millimeter, vector(-4.137900, -22.000000) * millimeter, vector(106.896600, -22.000000) * millimeter, vector(106.896600, -10.000000) * millimeter, vector(100.000000, 0.000000) * millimeter, vector(134.482800, -10.000000) * millimeter, vector(134.482800, -18.000000) * millimeter, vector(197.556600, -18.000000) * millimeter, vector(197.556600, -10.000000) * millimeter, vector(100.000000, 120.000000) * millimeter, vector(0.000000, 120.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2);
