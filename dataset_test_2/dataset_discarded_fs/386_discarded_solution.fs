...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(0.000000, -10.000000) * millimeter, vector(70.000000, -10.000000) * millimeter, vector(70.000000, 140.000000) * millimeter, vector(70.492600, 150.000000) * millimeter, vector(70.492600, 160.000000) * millimeter, vector(-0.492600, 160.000000) * millimeter, vector(-0.492600, 150.000000) * millimeter, vector(0.000000, 140.000000) * millimeter, vector(0.000000, -10.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(35.000000, 75.095779, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(-0.492600, -39.999995) * millimeter, vector(-0.492600, -48.000018) * millimeter, vector(70.492600, -48.000018) * millimeter, vector(70.492600, -39.999995) * millimeter, vector(70.000000, 0.000000) * millimeter, vector(70.000000, 179.999984) * millimeter, vector(0.000000, 179.999984) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1);
        ...
        // Flange 0->1_0_2: bend=79.88deg, zone=10mm
        ...
        var wallFace1_0_2a = qClosestTo(qCreatedBy(id + "flange0_1_0_2a", EntityType.FACE), vector(35.000000, -9.121197, 4.922165) * millimeter);
        var faceN1_0_2a = evPlane(context, { "face" : wallFace1_0_2a }).normal;
        var skN1_0_2a = dot(faceN1_0_2a, vector(0.0, -0.9844329521, 0.1757605271)) >= 0 ? faceN1_0_2a : -faceN1_0_2a;
        var sketchRem1_0_2a = newSketchOnPlane(context, id + "sketchRem1_0_2a", { "sketchPlane" : plane(vector(0.0, -8.2424, 9.8443) * millimeter, skN1_0_2a, vector(0.0, -0.1757605271, -0.9844329521)) });
        skPolyline(sketchRem1_0_2a, "polyRem1_0_2a", { "points" : [vector(7.999970, 0.000000) * millimeter, vector(7.999970, 70.000000) * millimeter, vector(-228.171483, 70.000000) * millimeter, vector(-228.171483, 0.000000) * millimeter, vector(7.999970, 0.000000) * millimeter] });
        skSolve(sketchRem1_0_2a);
        sheetMetalTab(context, id + "smTab1_0_2a", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem1_0_2a"), vector(0.000000, -9.121197, 4.922165) * millimeter),
            "booleanUnionScope" : wallFace1_0_2a,
            "booleanOffset" : 0.0 * millimeter
        });
        // Flange 1_0_2->2: bend=100.61deg, zone=10mm
