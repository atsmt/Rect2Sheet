...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(0.000000, -46.000000) * millimeter, vector(85.000000, -46.000000) * millimeter, vector(85.000000, 85.000000) * millimeter, vector(0.000000, 85.000000) * millimeter, vector(-14.000000, 107.153800) * millimeter, vector(-24.000000, 105.153800) * millimeter, vector(-24.000000, 76.153800) * millimeter, vector(-14.000000, 78.153800) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1);
        ...
        skPolyline(sketchRem3, "polyRem3", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(2.000000, -10.000000) * millimeter, vector(87.000000, -10.000000) * millimeter, vector(85.000000, 0.000000) * millimeter, vector(85.000000, 97.000000) * millimeter, vector(0.000000, 97.000000) * millimeter, vector(-26.000000, -49.846200) * millimeter, vector(-34.000000, -49.846200) * millimeter, vector(-34.000000, -78.846200) * millimeter, vector(-26.000000, -78.846200) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem3);
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(97.000000, 0.000000) * millimeter, vector(97.000000, 85.000000) * millimeter, vector(0.000000, 85.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2);
        sheetMetalTab(context, id + "smTab2", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem2"), vector(-5.000000, 18.500000, 157.000000) * millimeter),
            "booleanUnionScope" : qClosestTo(qCreatedBy(id + "flange3_2", EntityType.FACE), vector(-5.000000, 18.500000, 157.000000) * millimeter),
            "booleanOffset" : 0.0 * millimeter
        });
    });