...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(-3.852900, -60.000000) * millimeter, vector(-3.852900, -68.000000) * millimeter, vector(124.264700, -68.000000) * millimeter, vector(124.264700, -60.000000) * millimeter, vector(141.000000, 0.000000) * millimeter, vector(141.000000, 195.000000) * millimeter, vector(16.780500, 195.000000) * millimeter, vector(16.780500, 187.000000) * millimeter, vector(0.000000, 141.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1);
