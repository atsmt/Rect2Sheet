...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(120.000000, 0.000000) * millimeter, vector(120.000000, 80.000000) * millimeter, vector(113.902400, 120.000000) * millimeter, vector(113.902400, 130.000000) * millimeter, vector(12.443400, 130.000000) * millimeter, vector(12.443400, 120.000000) * millimeter, vector(0.000000, 80.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(60.668035, 63.233459, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(80.000000, 0.000000) * millimeter, vector(80.000000, 108.000000) * millimeter, vector(0.000000, 108.000000) * millimeter, vector(0.000000, 100.000000) * millimeter, vector(-3.902400, -30.000000) * millimeter, vector(-3.902400, -38.000000) * millimeter, vector(97.556600, -38.000000) * millimeter, vector(97.556600, -30.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1);
