...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(200.000000, 100.000000) * millimeter, vector(200.000000, -10.000000) * millimeter, vector(0.000000, -10.000000) * millimeter, vector(0.000000, 0.000000) * millimeter, vector(-270.000000, 0.000000) * millimeter, vector(-270.000000, 100.000000) * millimeter, vector(200.000000, 100.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(229.489796, 47.755102, 0.000000) * millimeter),
