...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(-40.000000, 50.000000) * millimeter, vector(-140.000000, 50.000000) * millimeter, vector(-140.000000, 200.000000) * millimeter, vector(-40.000000, 200.000000) * millimeter, vector(-40.000000, 50.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(-90.000000, 125.000000, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem2b, "polyRem2b", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(0.000000, -28.000000) * millimeter, vector(100.000000, -28.000000) * millimeter, vector(100.000000, 148.000000) * millimeter, vector(0.000000, 148.000000) * millimeter, vector(0.000000, 140.000000) * millimeter, vector(-30.000000, 103.076900) * millimeter, vector(-40.000000, 105.076900) * millimeter, vector(-40.000000, 43.846200) * millimeter, vector(-30.000000, 41.846200) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2b);
        ...
        skPolyline(sketchRem3, "polyRem3", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(-80.000000, 0.000000) * millimeter, vector(-140.000000, 51.846200) * millimeter, vector(-148.000000, 51.846200) * millimeter, vector(-148.000000, 113.076900) * millimeter, vector(-140.000000, 113.076900) * millimeter, vector(-80.000000, 180.000000) * millimeter, vector(0.000000, 180.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem3);
