...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(0.000000, -59.000000) * millimeter, vector(172.000000, -59.000000) * millimeter, vector(172.000000, 155.000000) * millimeter, vector(0.000000, 155.000000) * millimeter, vector(0.000000, 147.000000) * millimeter, vector(-51.000000, 147.000000) * millimeter, vector(-61.000000, 145.000000) * millimeter, vector(-61.000000, -2.000000) * millimeter, vector(-51.000000, 0.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1);
