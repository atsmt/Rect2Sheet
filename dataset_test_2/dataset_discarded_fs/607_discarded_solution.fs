...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(0.000000, -34.000000) * millimeter, vector(85.000000, -34.000000) * millimeter, vector(85.000000, 0.000000) * millimeter, vector(99.000000, 17.000000) * millimeter, vector(109.000000, 15.000000) * millimeter, vector(109.000000, 66.000000) * millimeter, vector(99.000000, 68.000000) * millimeter, vector(85.000000, 85.000000) * millimeter, vector(0.000000, 85.000000) * millimeter, vector(0.000000, -34.000000) * millimeter] });
        skSolve(sketchRem2);
