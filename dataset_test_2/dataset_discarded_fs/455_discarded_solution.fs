...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem1b, "polyRem1b", { "points" : [vector(8.870974, -8.000000) * millimeter, vector(58.770200, -53.000000) * millimeter, vector(58.770200, -65.000000) * millimeter, vector(-16.801200, -65.000000) * millimeter, vector(-16.801200, -53.000000) * millimeter, vector(0.000000, 222.000000) * millimeter, vector(158.000000, 222.000000) * millimeter, vector(158.000000, -8.000000) * millimeter, vector(8.870974, -8.000000) * millimeter] });
        skSolve(sketchRem1b);
