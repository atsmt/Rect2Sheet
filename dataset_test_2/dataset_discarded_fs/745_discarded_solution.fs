...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        sheetMetalFlange(context, id + "flange0_2", {
            "edges" : qClosestTo(qOwnedByBody(qBodyType(qCreatedBy(id + "smStart0", EntityType.BODY), BodyType.SOLID), EntityType.EDGE), vector(164.953700, -74.999900, 0.000000) * millimeter),
            "angleControlType" : SMFlangeAngleControlType.BEND_ANGLE,
        ...
        var wallFace2 = qClosestTo(qCreatedBy(id + "flange0_2", EntityType.FACE), vector(164.953700, -77.166355, -4.506270) * millimeter);
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(0.000000, 377.999964) * millimeter, vector(151.000000, 377.999964) * millimeter, vector(219.500100, -65.000070) * millimeter, vector(219.500100, -73.000072) * millimeter, vector(143.999800, -73.000072) * millimeter, vector(143.999800, -76.999939) * millimeter, vector(30.500100, -76.999939) * millimeter, vector(30.500100, -73.000072) * millimeter, vector(-69.592700, -73.000072) * millimeter, vector(-69.592700, -65.000070) * millimeter, vector(18.341907, -39.089169) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2);
        sheetMetalTab(context, id + "smTab2", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem2"), vector(164.953700, -107.496760, -67.594119) * millimeter),
