...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(-102.000000, 0.000000) * millimeter, vector(-82.500000, -19.000000) * millimeter, vector(-82.500000, -27.000000) * millimeter, vector(-115.862300, -27.000000) * millimeter, vector(-115.862300, -19.000000) * millimeter, vector(-102.000000, 262.000000) * millimeter, vector(0.000000, 262.000000) * millimeter, vector(10.000000, 260.000000) * millimeter, vector(10.000000, -2.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1);
