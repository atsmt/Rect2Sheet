...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(-182.572500, -24.000000) * millimeter, vector(-197.200000, -20.000000) * millimeter, vector(-100.000000, 200.000000) * millimeter, vector(-93.076900, 220.000000) * millimeter, vector(-93.076900, 228.000000) * millimeter, vector(-1.980400, 228.000000) * millimeter, vector(-1.980400, 220.000000) * millimeter, vector(0.000000, 200.000000) * millimeter, vector(0.000000, 0.000000) * millimeter, vector(-36.000000, -20.000000) * millimeter, vector(-36.000000, -32.000000) * millimeter, vector(-64.000000, -32.000000) * millimeter, vector(-64.000000, -20.000000) * millimeter, vector(-100.000000, 0.000000) * millimeter, vector(-167.945000, -20.000000) * millimeter, vector(-182.572500, -24.000000) * millimeter] });
        skSolve(sketchRem2);
        ...
        sheetMetalFlange(context, id + "flange2_3", {
            "edges" : qClosestTo(qOwnedByBody(qBodyType(qCreatedBy(id + "smStart0", EntityType.BODY), BodyType.SOLID), EntityType.EDGE), vector(-122.471350, 110.000000, -260.000000) * millimeter),
            "angleControlType" : SMFlangeAngleControlType.BEND_ANGLE,
            "bendAngle" : 90.000000 * degree,
            "limitType" : SMFlangeBoundingType.BLIND,
            "distance" : 10.000000 * millimeter,
        ...
        skPolyline(sketchRem3, "polyRem3", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(80.000000, 0.000000) * millimeter, vector(80.000000, 180.000000) * millimeter, vector(0.000000, 180.000000) * millimeter, vector(-3.076900, -10.000000) * millimeter, vector(-3.076900, -18.000000) * millimeter, vector(88.019600, -18.000000) * millimeter, vector(88.019600, -10.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem3);
        sheetMetalTab(context, id + "smTab3", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem3"), vector(-122.471350, 115.000000, -260.000000) * millimeter),
            "booleanUnionScope" : qClosestTo(qCreatedBy(id + "flange2_3", EntityType.FACE), vector(-122.471350, 115.000000, -260.000000) * millimeter),
            "booleanOffset" : 0.0 * millimeter
        });
    });