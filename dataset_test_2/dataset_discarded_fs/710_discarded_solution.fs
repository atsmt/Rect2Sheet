...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem2b, "polyRem2b", { "points" : [vector(17.307700, -8.000000) * millimeter, vector(86.538500, -40.000000) * millimeter, vector(86.538500, -52.000000) * millimeter, vector(-9.972400, -52.000000) * millimeter, vector(-9.972400, -40.000000) * millimeter, vector(0.000000, 140.000000) * millimeter, vector(80.000000, 140.000000) * millimeter, vector(80.000000, -8.000000) * millimeter, vector(17.307700, -8.000000) * millimeter] });
        skSolve(sketchRem2b);
