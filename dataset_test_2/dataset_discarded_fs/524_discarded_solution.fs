...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0_0, "poly0_0", { "points" : [vector(0.000000, 45.000000) * millimeter, vector(190.000000, 45.000000) * millimeter, vector(190.000000, 0.000000) * millimeter, vector(180.000000, 0.000000) * millimeter, vector(132.352900, -20.000000) * millimeter, vector(132.352900, -30.000000) * millimeter, vector(47.647100, -30.000000) * millimeter, vector(47.647100, -20.000000) * millimeter, vector(0.000000, 0.000000) * millimeter, vector(0.000000, 45.000000) * millimeter] });
        skSolve(sketch0_0);
        opExtractSurface(context, id + "surf0_0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0_0"), vector(93.549451, 12.280224, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(-47.647100, -40.000000) * millimeter, vector(-47.647100, -48.000000) * millimeter, vector(-132.352900, -48.000000) * millimeter, vector(-132.352900, -40.000000) * millimeter, vector(-180.000000, 0.000000) * millimeter, vector(-180.000000, 160.000000) * millimeter, vector(0.000000, 160.000000) * millimeter, vector(10.000000, 158.000000) * millimeter, vector(10.000000, -2.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1);
