...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem1b, "polyRem1b", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(42.500000, -40.000000) * millimeter, vector(44.500000, -50.000000) * millimeter, vector(92.000000, -50.000000) * millimeter, vector(90.000000, -40.000000) * millimeter, vector(180.000000, 0.000000) * millimeter, vector(188.000000, 0.000000) * millimeter, vector(188.000000, 140.000000) * millimeter, vector(180.000000, 140.000000) * millimeter, vector(180.000000, 150.000000) * millimeter, vector(182.000000, 160.000000) * millimeter, vector(2.000000, 160.000000) * millimeter, vector(0.000000, 150.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1b);
