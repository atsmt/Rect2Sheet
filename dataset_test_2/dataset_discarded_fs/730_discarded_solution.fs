...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(-36.161141, -10.761155) * millimeter, vector(-38.117600, -10.000000) * millimeter, vector(-35.999956, -10.000000) * millimeter, vector(0.000000, 160.000000) * millimeter, vector(200.000000, 160.000000) * millimeter, vector(240.000000, 130.000000) * millimeter, vector(250.000000, 130.000000) * millimeter, vector(250.000000, 7.352900) * millimeter, vector(240.000000, 7.352900) * millimeter, vector(200.000000, 0.000000) * millimeter, vector(172.413800, -10.000000) * millimeter, vector(172.413800, -20.000000) * millimeter, vector(27.586200, -20.000000) * millimeter, vector(27.586200, -10.000000) * millimeter, vector(0.000000, 0.000000) * millimeter, vector(-12.413800, -20.000000) * millimeter, vector(-25.265700, -15.000000) * millimeter, vector(-38.117600, -20.000000) * millimeter, vector(-36.161141, -10.761155) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(89.282863, 70.119113, 0.000000) * millimeter),
        ...
        sheetMetalFlange(context, id + "flange0_1", {
            "edges" : qClosestTo(qOwnedByBody(qBodyType(qCreatedBy(id + "smStart0", EntityType.BODY), BodyType.SOLID), EntityType.EDGE), vector(-50.000000, 68.676450, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(120.000000, 0.000000) * millimeter, vector(120.000000, 70.000000) * millimeter, vector(0.000000, 70.000000) * millimeter, vector(-2.647100, -20.000000) * millimeter, vector(-2.647100, -28.000000) * millimeter, vector(120.000000, -28.000000) * millimeter, vector(120.000000, -20.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1);
        sheetMetalTab(context, id + "smTab1", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem1"), vector(-50.000000, 68.676450, 5.000000) * millimeter),
            "booleanUnionScope" : qClosestTo(qCreatedBy(id + "flange0_1", EntityType.FACE), vector(-50.000000, 68.676450, 5.000000) * millimeter),
