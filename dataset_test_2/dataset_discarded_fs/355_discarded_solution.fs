...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(-36.000000, -20.000000) * millimeter, vector(-36.000000, -28.000000) * millimeter, vector(-64.000000, -28.000000) * millimeter, vector(-64.000000, -20.000000) * millimeter, vector(-100.000000, 0.000000) * millimeter, vector(-100.000000, 200.000000) * millimeter, vector(-98.019600, 220.000000) * millimeter, vector(-98.019600, 228.000000) * millimeter, vector(-6.923100, 228.000000) * millimeter, vector(-6.923100, 220.000000) * millimeter, vector(0.000000, 200.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2);
