...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(0.000000, 210.000000) * millimeter, vector(180.000000, 210.000000) * millimeter, vector(180.000000, 0.000000) * millimeter, vector(0.000000, 0.000000) * millimeter, vector(0.000000, 210.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(90.000000, 105.000000, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem3b, "polyRem3b", { "points" : [vector(-201.369400, -45.000000) * millimeter, vector(-220.757900, -40.000000) * millimeter, vector(-180.000000, 160.000000) * millimeter, vector(28.000000, 160.000000) * millimeter, vector(28.000000, 0.000000) * millimeter, vector(0.000000, 0.000000) * millimeter, vector(100.487800, -40.000000) * millimeter, vector(102.487800, -50.000000) * millimeter, vector(62.975600, -50.000000) * millimeter, vector(60.975600, -40.000000) * millimeter, vector(-180.000000, 0.000000) * millimeter, vector(-183.980900, -40.000000) * millimeter, vector(-201.369400, -45.000000) * millimeter] });
        skSolve(sketchRem3b);
