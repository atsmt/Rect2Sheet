...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem2b, "polyRem2b", { "points" : [vector(6.781800, -12.000000) * millimeter, vector(107.378500, -190.000000) * millimeter, vector(107.378500, -198.000000) * millimeter, vector(-65.882400, -198.000000) * millimeter, vector(-65.882400, -190.000000) * millimeter, vector(0.000000, 120.000000) * millimeter, vector(70.000000, 120.000000) * millimeter, vector(70.000000, -12.000000) * millimeter, vector(6.781800, -12.000000) * millimeter] });
        skSolve(sketchRem2b);
        ...
        sheetMetalFlange(context, id + "flange2_3", {
            "edges" : qClosestTo(qOwnedByBody(qBodyType(qCreatedBy(id + "smStart0", EntityType.BODY), BodyType.SOLID), EntityType.EDGE), vector(190.000000, 30.748050, 180.000000) * millimeter),
            "angleControlType" : SMFlangeAngleControlType.BEND_ANGLE,
        ...
        var wallFace3 = qClosestTo(qCreatedBy(id + "flange2_3", EntityType.FACE), vector(185.000000, 30.748050, 180.000000) * millimeter);
        ...
        skPolyline(sketchRem3, "polyRem3", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(120.000000, 0.000000) * millimeter, vector(160.000000, 2.621500) * millimeter, vector(168.000000, 2.621500) * millimeter, vector(168.000000, 175.882400) * millimeter, vector(160.000000, 175.882400) * millimeter, vector(120.000000, 180.000000) * millimeter, vector(0.000000, 180.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem3);
