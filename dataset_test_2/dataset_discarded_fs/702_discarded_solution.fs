...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(-40.000000, 50.000000) * millimeter, vector(-180.000000, 50.000000) * millimeter, vector(-180.000000, 138.000000) * millimeter, vector(-170.000000, 138.000000) * millimeter, vector(-140.000000, 170.000000) * millimeter, vector(-40.000000, 170.000000) * millimeter, vector(-40.000000, 50.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(-107.200000, 107.640000, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem3, "polyRem3", { "points" : [vector(0.000000, -10.000000) * millimeter, vector(-2.000000, -20.000000) * millimeter, vector(-90.000000, -20.000000) * millimeter, vector(-88.000000, -10.000000) * millimeter, vector(-80.000000, 0.000000) * millimeter, vector(-140.000000, 51.846200) * millimeter, vector(-148.000000, 51.846200) * millimeter, vector(-148.000000, 113.076900) * millimeter, vector(-140.000000, 113.076900) * millimeter, vector(-80.000000, 180.000000) * millimeter, vector(0.000000, 180.000000) * millimeter, vector(0.000000, -10.000000) * millimeter] });
        skSolve(sketchRem3);
