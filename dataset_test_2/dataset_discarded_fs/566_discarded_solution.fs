...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(-60.000000, 0.000000) * millimeter, vector(-220.000000, 0.000000) * millimeter, vector(-220.000000, 140.000000) * millimeter, vector(-189.655200, 150.000000) * millimeter, vector(-189.655200, 160.000000) * millimeter, vector(-59.549700, 160.000000) * millimeter, vector(-59.549700, 150.000000) * millimeter, vector(-60.000000, 140.000000) * millimeter, vector(-60.000000, 0.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(-138.774759, 78.712379, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem2b, "polyRem2b", { "points" : [vector(-140.000000, 0.000000) * millimeter, vector(-199.549700, -40.000000) * millimeter, vector(-197.549700, -50.000000) * millimeter, vector(-327.655200, -50.000000) * millimeter, vector(-329.655200, -40.000000) * millimeter, vector(-140.000000, 180.000000) * millimeter, vector(8.000000, 180.000000) * millimeter, vector(8.000000, 0.000000) * millimeter, vector(-140.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2b);
