...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(85.000000, 0.000000) * millimeter, vector(85.000000, 219.000000) * millimeter, vector(-10.000000, 219.000000) * millimeter, vector(-10.000000, 0.000000) * millimeter, vector(85.000000, 0.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(37.500000, 109.500000, 0.000000) * millimeter),
        ...
        sheetMetalFlange(context, id + "flange0_1_0_2a", {
            "edges" : qClosestTo(qOwnedByBody(qBodyType(qCreatedBy(id + "smStart0", EntityType.BODY), BodyType.SOLID), EntityType.EDGE), vector(-10.000000, 109.500000, 0.000000) * millimeter),
        ...
        var sketchRem1_0_2a = newSketchOnPlane(context, id + "sketchRem1_0_2a", { "sketchPlane" : plane(vector(-10.0, 219.0, 10.0) * millimeter, vector(-1.0, 0.0, 0.0), vector(0.0, 0.0, -1.0)) });
        skPolyline(sketchRem1_0_2a, "polyRem1_0_2a", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(8.000000, 0.000000) * millimeter, vector(8.000000, 219.000000) * millimeter, vector(0.000000, 219.000000) * millimeter, vector(-137.000000, 243.000000) * millimeter, vector(-145.000000, 243.000000) * millimeter, vector(-145.000000, 158.000000) * millimeter, vector(-137.000000, 158.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1_0_2a);
        sheetMetalTab(context, id + "smTab1_0_2a", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem1_0_2a"), vector(-10.000000, 109.500000, 5.000000) * millimeter),
            "booleanUnionScope" : qClosestTo(qCreatedBy(id + "flange0_1_0_2a", EntityType.FACE), vector(-10.000000, 109.500000, 5.000000) * millimeter),
        ...
        skPolyline(sketchRem2b, "polyRem2b", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(-26.153800, -26.000000) * millimeter, vector(-28.153800, -36.000000) * millimeter, vector(-60.846200, -36.000000) * millimeter, vector(-58.846200, -26.000000) * millimeter, vector(-85.000000, 0.000000) * millimeter, vector(-93.000000, 0.000000) * millimeter, vector(-93.000000, 85.000000) * millimeter, vector(0.000000, 85.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2b);
        sheetMetalTab(context, id + "smTab2b", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem2b"), vector(-5.000000, 18.500000, 157.000000) * millimeter),
            "booleanUnionScope" : qClosestTo(qCreatedBy(id + "flange1_0_2_2b", EntityType.FACE), vector(-5.000000, 18.500000, 157.000000) * millimeter),
            "booleanOffset" : 0.0 * millimeter
        });
