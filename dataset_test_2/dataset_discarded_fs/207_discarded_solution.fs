...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(208.000000, 0.000000) * millimeter, vector(208.000000, 80.000000) * millimeter, vector(200.000000, 80.000000) * millimeter, vector(170.950200, 90.000000) * millimeter, vector(172.950200, 100.000000) * millimeter, vector(2.000000, 100.000000) * millimeter, vector(0.000000, 90.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1);
