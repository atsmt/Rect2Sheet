...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem2b, "polyRem2b", { "points" : [vector(30.461520, -8.000000) * millimeter, vector(76.153800, -20.000000) * millimeter, vector(76.153800, -32.000000) * millimeter, vector(-29.671200, -32.000000) * millimeter, vector(-29.671200, -20.000000) * millimeter, vector(0.000000, 160.000000) * millimeter, vector(100.000000, 160.000000) * millimeter, vector(100.000000, -8.000000) * millimeter, vector(30.461520, -8.000000) * millimeter] });
        skSolve(sketchRem2b);
        ...
        sheetMetalFlange(context, id + "flange2_1", {
            "edges" : qClosestTo(qOwnedByBody(qBodyType(qCreatedBy(id + "smStart0", EntityType.BODY), BodyType.SOLID), EntityType.EDGE), vector(-20.000000, 106.758700, -10.000000) * millimeter),
            "angleControlType" : SMFlangeAngleControlType.BEND_ANGLE,
        ...
        var wallFace1 = qClosestTo(qCreatedBy(id + "flange2_1", EntityType.FACE), vector(-20.000000, 106.758700, -15.000000) * millimeter);
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(0.328800, -10.000000) * millimeter, vector(0.328800, -18.000000) * millimeter, vector(106.153800, -18.000000) * millimeter, vector(106.153800, -10.000000) * millimeter, vector(140.000000, 0.000000) * millimeter, vector(140.000000, 180.000000) * millimeter, vector(0.000000, 180.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1);
        sheetMetalTab(context, id + "smTab1", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem1"), vector(-20.000000, 106.758700, -30.000000) * millimeter),
