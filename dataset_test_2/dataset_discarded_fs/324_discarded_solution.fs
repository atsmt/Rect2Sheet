...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0_0, "poly0_0", { "points" : [vector(-40.000000, 1.805100) * millimeter, vector(-50.000000, 1.805100) * millimeter, vector(-50.000000, 43.970600) * millimeter, vector(-40.000000, 43.970600) * millimeter, vector(0.000000, 55.000000) * millimeter, vector(100.000000, 55.000000) * millimeter, vector(100.000000, -10.000000) * millimeter, vector(0.000000, -10.000000) * millimeter, vector(0.000000, 0.000000) * millimeter, vector(-40.000000, 1.805100) * millimeter] });
        skSolve(sketch0_0);
        opExtractSurface(context, id + "surf0_0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0_0"), vector(30.329572, 23.131247, 0.000000) * millimeter),
