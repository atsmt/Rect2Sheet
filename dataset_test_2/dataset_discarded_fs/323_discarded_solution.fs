...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(0.000000, -10.000000) * millimeter, vector(100.000000, -10.000000) * millimeter, vector(100.000000, 0.000000) * millimeter, vector(140.000000, 4.963900) * millimeter, vector(150.000000, 4.963900) * millimeter, vector(150.000000, 112.647100) * millimeter, vector(140.000000, 112.647100) * millimeter, vector(100.000000, 120.000000) * millimeter, vector(0.000000, 120.000000) * millimeter, vector(0.000000, -10.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(27.487809, 56.298708, 0.000000) * millimeter),
