...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem2b, "polyRem2b", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(151.000000, 0.000000) * millimeter, vector(151.000000, 377.999964) * millimeter, vector(5.710100, 406.803044) * millimeter, vector(-2.137180, 408.358750) * millimeter, vector(-79.950480, 15.849880) * millimeter, vector(-72.103200, 14.294174) * millimeter, vector(0.000000, 377.999964) * millimeter, vector(-44.999900, -64.999980) * millimeter, vector(-46.961720, -74.611016) * millimeter, vector(247.671380, -74.611016) * millimeter, vector(249.633200, -64.999980) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2b);
        ...
        sheetMetalFlange(context, id + "flange2_3", {
            "edges" : qClosestTo(qOwnedByBody(qBodyType(qCreatedBy(id + "smStart0", EntityType.BODY), BodyType.SOLID), EntityType.EDGE), vector(192.316650, -75.000000, -0.000100) * millimeter),
            "angleControlType" : SMFlangeAngleControlType.BEND_ANGLE,
        ...
        var wallFace3 = qClosestTo(qCreatedBy(id + "flange2_3", EntityType.FACE), vector(192.316650, -75.000000, 4.999900) * millimeter);
