...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(-60.000000, 99.615400) * millimeter, vector(-50.000000, 99.615400) * millimeter, vector(-50.000000, 55.000000) * millimeter, vector(-40.000000, 55.000000) * millimeter, vector(0.000000, 100.000000) * millimeter, vector(160.000000, 100.000000) * millimeter, vector(170.000000, 86.206900) * millimeter, vector(180.000000, 86.206900) * millimeter, vector(180.000000, 9.655200) * millimeter, vector(170.000000, 9.655200) * millimeter, vector(160.000000, 0.000000) * millimeter, vector(0.000000, 0.000000) * millimeter, vector(-40.000000, 0.647700) * millimeter, vector(-50.000000, 0.647700) * millimeter, vector(-50.000000, 0.384600) * millimeter, vector(-60.000000, 0.384600) * millimeter, vector(-60.000000, 0.000000) * millimeter, vector(-130.000000, 0.000000) * millimeter, vector(-130.000000, 100.000000) * millimeter, vector(-60.000000, 100.000000) * millimeter, vector(-60.000000, 99.615400) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(25.955083, 48.450183, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(0.000000, 140.000000) * millimeter, vector(80.000000, 140.000000) * millimeter, vector(89.279753, -38.603709) * millimeter, vector(89.615400, -40.000000) * millimeter, vector(89.615400, -52.000000) * millimeter, vector(-9.615400, -52.000000) * millimeter, vector(-9.615400, -40.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2);
