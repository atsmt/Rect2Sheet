...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(199.355647, 47.795452, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(143.999805, -64.999937) * millimeter, vector(144.000100, -65.000070) * millimeter, vector(144.000100, -73.000072) * millimeter, vector(143.999800, -73.000072) * millimeter, vector(143.999800, -76.999939) * millimeter, vector(30.500100, -76.999939) * millimeter, vector(30.500100, -73.000072) * millimeter, vector(-82.379000, -73.000072) * millimeter, vector(-82.379000, -65.000070) * millimeter, vector(0.000000, 377.999964) * millimeter, vector(151.000000, 377.999964) * millimeter, vector(151.000000, 0.000000) * millimeter, vector(143.999805, -64.999937) * millimeter] });
        skSolve(sketchRem2);
