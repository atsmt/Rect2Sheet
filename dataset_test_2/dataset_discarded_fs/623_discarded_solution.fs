...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem1b, "polyRem1b", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(80.000000, 0.000000) * millimeter, vector(118.005057, 0.142134) * millimeter, vector(118.005057, 100.142134) * millimeter, vector(80.000000, 100.000000) * millimeter, vector(0.404000, 105.671000) * millimeter, vector(-7.575757, 106.239566) * millimeter, vector(-15.068557, 1.073566) * millimeter, vector(-7.088800, 0.505100) * millimeter, vector(0.000000, 100.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1b);
        ...
        var sketchRem1_1_2a = newSketchOnPlane(context, id + "sketchRem1_1_2a", { "sketchPlane" : plane(vector(-10.0, 120.0, -140.0) * millimeter, vector(1.0, 0.0, 0.0), vector(0.0, 1.0, 0.0)) });
        skPolyline(sketchRem1_1_2a, "polyRem1_1_2a", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(8.000000, 0.000000) * millimeter, vector(8.000000, 100.000000) * millimeter, vector(0.000000, 100.000000) * millimeter, vector(-160.000000, 250.000000) * millimeter, vector(-168.000000, 250.000000) * millimeter, vector(-168.000000, 170.000000) * millimeter, vector(-160.000000, 170.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1_1_2a);
        sheetMetalTab(context, id + "smTab1_1_2a", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem1_1_2a"), vector(-10.000000, 125.000000, -90.000000) * millimeter),
            "booleanUnionScope" : qClosestTo(qCreatedBy(id + "flange1_1_1_2a", EntityType.FACE), vector(-10.000000, 125.000000, -90.000000) * millimeter),
            "booleanOffset" : 0.0 * millimeter
        });
        ...
        sheetMetalTab(context, id + "smTab2b", {
            ...
            "booleanUnionScope" : qClosestTo(qCreatedBy(id + "flange1_1_2_2b", EntityType.FACE), vector(-5.000000, -50.000000, 70.000000) * millimeter),
            "booleanOffset" : 0.0 * millimeter
        });
    });