...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem3, "polyRem3", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(2.000000, -10.000015) * millimeter, vector(-78.000000, -10.000015) * millimeter, vector(-80.000000, 0.000000) * millimeter, vector(-80.000000, 139.999977) * millimeter, vector(0.000000, 139.999977) * millimeter, vector(40.000000, 42.447318) * millimeter, vector(48.000000, 42.447318) * millimeter, vector(48.000000, 8.882857) * millimeter, vector(40.000000, 8.882857) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem3);
