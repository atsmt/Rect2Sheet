...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(123.000000, 0.000000) * millimeter, vector(123.000000, 113.000000) * millimeter, vector(-10.000000, 113.000000) * millimeter, vector(-10.000000, 0.000000) * millimeter, vector(123.000000, 0.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(56.500000, 56.500000, 0.000000) * millimeter),
