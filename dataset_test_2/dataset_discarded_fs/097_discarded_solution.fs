...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(210.000000, 0.000000) * millimeter, vector(210.000000, 200.000000) * millimeter, vector(200.000000, 200.000000) * millimeter, vector(220.000000, 208.630100) * millimeter, vector(230.000000, 208.630100) * millimeter, vector(230.000000, 256.969200) * millimeter, vector(220.000000, 256.969200) * millimeter, vector(0.000000, 200.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(88.634548, 116.459461, 0.000000) * millimeter),
        ...
        sheetMetalFlange(context, id + "flange0_2_0", {
            "edges" : qClosestTo(qOwnedByBody(qBodyType(qCreatedBy(id + "smStart0", EntityType.BODY), BodyType.SOLID), EntityType.EDGE), vector(-30.000000, 232.799650, 0.000000) * millimeter),
            "angleControlType" : SMFlangeAngleControlType.BEND_ANGLE,
        ...
        skPolyline(sketchRem2_0, "polyRem2_0", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(100.000000, -61.369900) * millimeter, vector(108.000000, -61.369900) * millimeter, vector(108.000000, -13.030800) * millimeter, vector(100.000000, -13.030800) * millimeter, vector(30.000000, 0.000000) * millimeter, vector(30.000000, 80.000000) * millimeter, vector(0.000000, 80.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2_0);
        sheetMetalTab(context, id + "smTab2_0", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem2_0"), vector(-30.000000, 232.799650, -5.000000) * millimeter),
            "booleanUnionScope" : qClosestTo(qCreatedBy(id + "flange0_2_0", EntityType.FACE), vector(-30.000000, 232.799650, -5.000000) * millimeter),
            "booleanOffset" : 0.0 * millimeter
        });
