...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem2b, "polyRem2b", { "points" : [vector(0.000000, 140.000000) * millimeter, vector(80.000000, 140.000000) * millimeter, vector(89.615400, -40.000000) * millimeter, vector(89.615400, -52.000000) * millimeter, vector(-9.751400, -52.000000) * millimeter, vector(-9.751400, -40.000000) * millimeter, vector(62.049720, -8.000000) * millimeter, vector(0.000000, -8.000000) * millimeter, vector(0.000000, 140.000000) * millimeter] });
        skSolve(sketchRem2b);
