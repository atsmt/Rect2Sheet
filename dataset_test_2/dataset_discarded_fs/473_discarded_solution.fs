...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(0.000000, 199.872200) * millimeter, vector(0.000000, 200.000000) * millimeter, vector(200.000000, 200.000000) * millimeter, vector(200.000000, 0.000000) * millimeter, vector(0.000000, 0.000000) * millimeter, vector(0.000000, 4.615400) * millimeter, vector(-10.000000, 4.615400) * millimeter, vector(-10.000000, 71.219500) * millimeter, vector(-20.000000, 71.219500) * millimeter, vector(-50.000000, 40.000000) * millimeter, vector(-230.000000, 40.000000) * millimeter, vector(-230.000000, 200.000000) * millimeter, vector(-10.000000, 200.000000) * millimeter, vector(-10.000000, 199.872200) * millimeter, vector(0.000000, 199.872200) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(-2.815573, 109.760947, 0.000000) * millimeter),
