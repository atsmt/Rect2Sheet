...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(98.000000, 0.000000) * millimeter, vector(38.243900, -60.000000) * millimeter, vector(38.243900, -68.000000) * millimeter, vector(138.762100, -68.000000) * millimeter, vector(138.762100, -60.000000) * millimeter, vector(98.000000, 169.000000) * millimeter, vector(78.400000, 215.000000) * millimeter, vector(78.400000, 223.000000) * millimeter, vector(19.600000, 223.000000) * millimeter, vector(19.600000, 215.000000) * millimeter, vector(0.000000, 169.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2);
