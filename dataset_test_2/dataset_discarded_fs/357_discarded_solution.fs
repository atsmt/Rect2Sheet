...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(0.000000, -32.000000) * millimeter, vector(100.000000, -32.000000) * millimeter, vector(100.000000, 0.000000) * millimeter, vector(125.200000, -20.000000) * millimeter, vector(125.200000, -28.000000) * millimeter, vector(156.969200, -28.000000) * millimeter, vector(156.969200, -20.000000) * millimeter, vector(100.000000, 200.000000) * millimeter, vector(0.000000, 200.000000) * millimeter, vector(0.000000, -32.000000) * millimeter] });
        skSolve(sketchRem2);
