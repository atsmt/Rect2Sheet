...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0_0, "poly0_0", { "points" : [vector(-105.000000, 110.000000) * millimeter, vector(42.500000, 110.000000) * millimeter, vector(42.500000, 100.000000) * millimeter, vector(-10.000000, 80.000000) * millimeter, vector(-10.000000, 0.000000) * millimeter, vector(-105.000000, 0.000000) * millimeter, vector(-105.000000, 110.000000) * millimeter] });
        skSolve(sketch0_0);
        opExtractSurface(context, id + "surf0_0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0_0"), vector(53.834239, 59.032609, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem1b, "polyRem1b", { "points" : [vector(0.000000, -28.000000) * millimeter, vector(147.500000, -28.000000) * millimeter, vector(147.500000, -20.000000) * millimeter, vector(200.000000, 0.000000) * millimeter, vector(200.000000, 128.000000) * millimeter, vector(0.000000, 128.000000) * millimeter, vector(0.000000, -28.000000) * millimeter] });
        skSolve(sketchRem1b);
