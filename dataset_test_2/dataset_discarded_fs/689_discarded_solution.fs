...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(230.000000, -1.076900) * millimeter, vector(240.000000, -1.076900) * millimeter, vector(240.000000, -52.769200) * millimeter, vector(230.000000, -52.769200) * millimeter, vector(120.000000, -70.000000) * millimeter, vector(120.000000, -190.000000) * millimeter, vector(0.000000, -190.000000) * millimeter, vector(0.000000, -70.000000) * millimeter, vector(230.000000, -1.076900) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(92.147273, -100.375226, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem2b, "polyRem2b", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(70.000000, 0.000000) * millimeter, vector(70.000000, 188.000000) * millimeter, vector(0.000000, 188.000000) * millimeter, vector(0.000000, 180.000000) * millimeter, vector(-52.769200, -20.000000) * millimeter, vector(-52.769200, -28.000000) * millimeter, vector(-1.076900, -28.000000) * millimeter, vector(-1.076900, -20.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2b);
