...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(0.000000, -32.000000) * millimeter, vector(-100.000000, -32.000000) * millimeter, vector(-100.000000, 0.000000) * millimeter, vector(-167.945000, -20.000000) * millimeter, vector(-167.945000, -28.000000) * millimeter, vector(-197.200000, -28.000000) * millimeter, vector(-197.200000, -20.000000) * millimeter, vector(-100.000000, 200.000000) * millimeter, vector(0.000000, 200.000000) * millimeter, vector(0.000000, -32.000000) * millimeter] });
        skSolve(sketchRem2);
