...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(-100.337079, 121.382022, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem2b, "polyRem2b", { "points" : [vector(0.000000, -28.000000) * millimeter, vector(100.000000, -28.000000) * millimeter, vector(100.000000, 148.000000) * millimeter, vector(0.000000, 148.000000) * millimeter, vector(0.000000, -28.000000) * millimeter] });
        skSolve(sketchRem2b);
        ...
        skPolyline(sketchRem3, "polyRem3", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(-24.000000, -10.000000) * millimeter, vector(-24.000000, -18.000000) * millimeter, vector(-64.000000, -18.000000) * millimeter, vector(-64.000000, -10.000000) * millimeter, vector(-80.000000, 0.000000) * millimeter, vector(-80.000000, 180.000000) * millimeter, vector(0.000000, 180.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem3);
