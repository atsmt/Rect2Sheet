...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem3, "polyRem3", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(-12.000000, -10.000000) * millimeter, vector(-12.000000, -18.000000) * millimeter, vector(116.000000, -18.000000) * millimeter, vector(116.000000, -10.000000) * millimeter, vector(180.000000, 0.000000) * millimeter, vector(180.000000, 200.000000) * millimeter, vector(0.000000, 200.000000) * millimeter, vector(-10.000000, 199.846200) * millimeter, vector(-20.000000, 197.846200) * millimeter, vector(-20.000000, 36.000000) * millimeter, vector(-10.000000, 38.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem3);
        ...
        sheetMetalFlange(context, id + "flange3_2", {
            "edges" : qClosestTo(qOwnedByBody(qBodyType(qCreatedBy(id + "smStart0", EntityType.BODY), BodyType.SOLID), EntityType.EDGE), vector(-40.000000, -40.000000, 138.923100) * millimeter),
            "angleControlType" : SMFlangeAngleControlType.BEND_ANGLE,
            "bendAngle" : 90.000000 * degree,
            "limitType" : SMFlangeBoundingType.BLIND,
            "distance" : 10.000000 * millimeter,
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(120.000000, 0.000000) * millimeter, vector(120.000000, 160.000000) * millimeter, vector(150.000000, 8.000000) * millimeter, vector(158.000000, 8.000000) * millimeter, vector(158.000000, 169.846200) * millimeter, vector(150.000000, 169.846200) * millimeter, vector(0.000000, 160.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2);
        sheetMetalTab(context, id + "smTab2", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem2"), vector(-35.000000, -40.000000, 138.923100) * millimeter),
            "booleanUnionScope" : qClosestTo(qCreatedBy(id + "flange3_2", EntityType.FACE), vector(-35.000000, -40.000000, 138.923100) * millimeter),
            "booleanOffset" : 0.0 * millimeter
        });
    });