...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(208.000000, 0.000000) * millimeter, vector(208.000000, 80.000000) * millimeter, vector(200.000000, 80.000000) * millimeter, vector(144.667000, 90.000000) * millimeter, vector(146.667000, 100.000000) * millimeter, vector(28.283200, 100.000000) * millimeter, vector(26.283200, 90.000000) * millimeter, vector(0.000000, 80.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1);
