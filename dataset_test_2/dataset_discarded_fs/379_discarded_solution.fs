...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(70.000000, 0.000000) * millimeter, vector(72.131800, 150.000000) * millimeter, vector(72.131800, 160.000000) * millimeter, vector(-2.662800, 160.000000) * millimeter, vector(-2.662800, 150.000000) * millimeter, vector(70.000000, 140.000000) * millimeter, vector(0.000000, 140.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(35.851510, 78.691606, 0.000000) * millimeter),
        ...
        sheetMetalFlange(context, id + "flange0_1", {
            "edges" : qClosestTo(qOwnedByBody(qBodyType(qCreatedBy(id + "smStart0", EntityType.BODY), BodyType.SOLID), EntityType.EDGE), vector(34.734500, 160.000000, 0.000000) * millimeter),
        ...
        var wallFace1 = qClosestTo(qCreatedBy(id + "flange0_1", EntityType.FACE), vector(34.734500, 157.927130, 4.550078) * millimeter);
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(70.000000, 0.000000) * millimeter, vector(-2.131800, -39.999995) * millimeter, vector(-2.131800, -48.000018) * millimeter, vector(72.662800, -48.000018) * millimeter, vector(72.662800, -39.999995) * millimeter, vector(70.000000, 179.999984) * millimeter, vector(70.000000, 188.000007) * millimeter, vector(0.000000, 188.000007) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1);
        sheetMetalTab(context, id + "smTab1", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem1"), vector(34.734500, 139.271296, 45.500798) * millimeter),
            "booleanUnionScope" : wallFace1,
            "booleanOffset" : 0.0 * millimeter
        });

        // === Child Tab 2 from 1 (two_bend) ===
        // Flange 1->1_1_2: bend=147.00deg, zone=10mm
        ...
        // Flange 1_1_2->2: bend=33.00deg, zone=10mm
