...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(0.000000, -10.000000) * millimeter, vector(70.000000, -10.000000) * millimeter, vector(70.000000, 160.000000) * millimeter, vector(0.000000, 160.000000) * millimeter, vector(0.000000, -10.000000) * millimeter] });
        skSolve(sketch0);
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(0.000000, -48.000018) * millimeter, vector(70.000000, -48.000018) * millimeter, vector(70.000000, 179.999984) * millimeter, vector(0.000000, 179.999984) * millimeter, vector(0.000000, -48.000018) * millimeter] });
        skSolve(sketchRem1);
