...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(0.000000, -46.000000) * millimeter, vector(85.000000, -46.000000) * millimeter, vector(85.000000, 0.000000) * millimeter, vector(95.000000, -2.000000) * millimeter, vector(95.000000, 83.000000) * millimeter, vector(85.000000, 85.000000) * millimeter, vector(0.000000, 85.000000) * millimeter, vector(-14.000000, 107.153800) * millimeter, vector(-24.000000, 105.153800) * millimeter, vector(-24.000000, 76.153800) * millimeter, vector(-14.000000, 78.153800) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1);
        ...
        skPolyline(sketchRem2b, "polyRem2b", { "points" : [vector(-85.000000, 0.000000) * millimeter, vector(-85.000000, 85.000000) * millimeter, vector(8.000000, 85.000000) * millimeter, vector(8.000000, 0.000000) * millimeter, vector(-85.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2b);
