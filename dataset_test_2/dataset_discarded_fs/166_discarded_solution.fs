...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(379.000000, 0.000000) * millimeter, vector(379.000000, 157.000000) * millimeter, vector(0.000000, 157.000000) * millimeter, vector(0.000000, 147.000000) * millimeter, vector(-10.000000, 147.000000) * millimeter, vector(-10.000000, 0.000000) * millimeter, vector(379.000000, 0.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(184.810793, 78.379455, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem1b, "polyRem1b", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(387.000000, 0.000000) * millimeter, vector(387.000000, 252.000000) * millimeter, vector(379.000000, 252.000000) * millimeter, vector(289.529500, 411.000000) * millimeter, vector(291.529500, 421.000000) * millimeter, vector(49.124400, 421.000000) * millimeter, vector(47.124400, 411.000000) * millimeter, vector(0.000000, 252.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1b);
        ...
        skPolyline(sketchRem3, "polyRem3", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(-4.470500, -11.000000) * millimeter, vector(-4.470500, -19.000000) * millimeter, vector(-246.875600, -19.000000) * millimeter, vector(-246.875600, -11.000000) * millimeter, vector(-252.000000, 0.000000) * millimeter, vector(-252.000000, 379.000000) * millimeter, vector(0.000000, 379.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem3);
