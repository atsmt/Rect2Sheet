...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(0.000000, 460.000000) * millimeter, vector(400.000000, 460.000000) * millimeter, vector(400.000000, 450.000000) * millimeter, vector(515.000000, 330.882400) * millimeter, vector(525.000000, 330.882400) * millimeter, vector(525.000000, 119.117600) * millimeter, vector(515.000000, 119.117600) * millimeter, vector(400.000000, 0.000000) * millimeter, vector(0.000000, 0.000000) * millimeter, vector(0.000000, 460.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(245.560902, 229.104044, 0.000000) * millimeter),
