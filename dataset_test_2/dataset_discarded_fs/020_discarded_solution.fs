...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(100.000000, 0.000000) * millimeter, vector(120.000000, -15.882400) * millimeter, vector(130.000000, -17.882400) * millimeter, vector(130.000000, 70.921300) * millimeter, vector(120.000000, 72.921300) * millimeter, vector(100.000000, 80.000000) * millimeter, vector(0.000000, 80.000000) * millimeter, vector(-5.517200, -10.000000) * millimeter, vector(-5.517200, -18.000000) * millimeter, vector(80.000000, -18.000000) * millimeter, vector(80.000000, -10.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2);
