...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0_0, "poly0_0", { "points" : [vector(0.000000, 286.000000) * millimeter, vector(34.112600, 307.000000) * millimeter, vector(34.112600, 317.000000) * millimeter, vector(189.824600, 317.000000) * millimeter, vector(189.824600, 307.000000) * millimeter, vector(190.000000, 286.000000) * millimeter, vector(190.000000, 148.000000) * millimeter, vector(0.000000, 148.000000) * millimeter, vector(0.000000, 286.000000) * millimeter] });
        skSolve(sketch0_0);
        opExtractSurface(context, id + "surf0_0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0_0"), vector(96.789461, 230.858314, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem1b, "polyRem1b", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(158.000000, 0.000000) * millimeter, vector(17.112600, -53.000000) * millimeter, vector(15.116141, -62.881037) * millimeter, vector(170.828141, -62.881037) * millimeter, vector(172.824600, -53.000000) * millimeter, vector(158.000000, 222.000000) * millimeter, vector(0.559000, 231.381400) * millimeter, vector(-7.426841, 231.857237) * millimeter, vector(-21.167341, 1.261337) * millimeter, vector(-13.181500, 0.785400) * millimeter, vector(0.000000, 222.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1b);
