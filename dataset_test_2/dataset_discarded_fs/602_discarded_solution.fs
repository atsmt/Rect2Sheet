...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(-80.000000, 0.000000) * millimeter, vector(-38.396200, -10.000000) * millimeter, vector(-38.396200, -18.000000) * millimeter, vector(-82.000000, -18.000000) * millimeter, vector(-82.000000, -10.000000) * millimeter, vector(-80.000000, 120.000000) * millimeter, vector(0.000000, 120.000000) * millimeter, vector(27.735800, -10.000000) * millimeter, vector(27.735800, -22.000000) * millimeter, vector(-5.000000, -22.000000) * millimeter, vector(-5.000000, -10.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1);
