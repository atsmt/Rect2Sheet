...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem3, "polyRem3", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(80.000000, 0.000000) * millimeter, vector(-0.030800, -40.000000) * millimeter, vector(-0.030800, -48.000000) * millimeter, vector(92.295100, -48.000000) * millimeter, vector(92.295100, -40.000000) * millimeter, vector(80.000000, 120.000000) * millimeter, vector(0.000000, 120.000000) * millimeter, vector(-10.000000, 122.000000) * millimeter, vector(-10.000000, 2.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem3);
