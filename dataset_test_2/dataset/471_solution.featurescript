...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(160.000000, 100.000000) * millimeter, vector(170.000000, 86.206900) * millimeter, vector(180.000000, 86.206900) * millimeter, vector(180.000000, 9.655200) * millimeter, vector(170.000000, 9.655200) * millimeter, vector(160.000000, 0.000000) * millimeter, vector(-60.000000, 0.000000) * millimeter, vector(-60.000000, -10.000000) * millimeter, vector(-130.000000, -10.000000) * millimeter, vector(-130.000000, 100.000000) * millimeter, vector(160.000000, 100.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(20.668608, 48.693498, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(102.000000, 0.000000) * millimeter, vector(102.000000, 140.000000) * millimeter, vector(0.000000, 140.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2);
        sheetMetalTab(context, id + "smTab2", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem2"), vector(-50.000000, -5.000000, -120.000000) * millimeter),
            "booleanUnionScope" : qClosestTo(qCreatedBy(id + "flange3_2", EntityType.FACE), vector(-50.000000, -5.000000, -120.000000) * millimeter),
            "booleanOffset" : 0.0 * millimeter
        });
    });