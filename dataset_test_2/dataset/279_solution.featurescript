...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(200.000000, 0.000000) * millimeter, vector(240.000000, 7.352900) * millimeter, vector(250.000000, 7.352900) * millimeter, vector(250.000000, 137.941200) * millimeter, vector(240.000000, 137.941200) * millimeter, vector(200.000000, 160.000000) * millimeter, vector(0.000000, 160.000000) * millimeter, vector(-38.117600, -10.000000) * millimeter, vector(-38.117600, -20.000000) * millimeter, vector(-12.413800, -20.000000) * millimeter, vector(-12.413800, -10.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(88.439194, 76.303701, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(-2.647100, -20.000000) * millimeter, vector(-2.647100, -28.000000) * millimeter, vector(127.941200, -28.000000) * millimeter, vector(127.941200, -20.000000) * millimeter, vector(120.000000, 0.000000) * millimeter, vector(120.000000, 70.000000) * millimeter, vector(0.000000, 70.000000) * millimeter, vector(-20.000000, 99.117600) * millimeter, vector(-30.000000, 97.117600) * millimeter, vector(-30.000000, 3.294100) * millimeter, vector(-20.000000, 5.294100) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1);
