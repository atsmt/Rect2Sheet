...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(130.000000, 0.000000) * millimeter, vector(130.000000, 70.000000) * millimeter, vector(-10.000000, 70.000000) * millimeter, vector(-10.000000, 0.000000) * millimeter, vector(130.000000, 0.000000) * millimeter] });
        skSolve(sketch0);
