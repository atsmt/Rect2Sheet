...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(-8.400000, -32.000000) * millimeter, vector(-8.400000, -40.000000) * millimeter, vector(269.000000, -40.000000) * millimeter, vector(269.000000, -32.000000) * millimeter, vector(252.000000, 0.000000) * millimeter, vector(252.000000, 379.000000) * millimeter, vector(217.241400, 474.000000) * millimeter, vector(217.241400, 482.000000) * millimeter, vector(34.758600, 482.000000) * millimeter, vector(34.758600, 474.000000) * millimeter, vector(0.000000, 379.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2);
