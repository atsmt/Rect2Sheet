...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(25.000000, -10.000000) * millimeter, vector(25.000000, -20.000000) * millimeter, vector(135.000000, -20.000000) * millimeter, vector(135.000000, -10.000000) * millimeter, vector(140.000000, 0.000000) * millimeter, vector(140.000000, 100.000000) * millimeter, vector(0.000000, 100.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(71.039755, 41.437309, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(-25.000000, -10.000000) * millimeter, vector(-25.000000, -18.000000) * millimeter, vector(85.000000, -18.000000) * millimeter, vector(85.000000, -10.000000) * millimeter, vector(80.000000, 0.000000) * millimeter, vector(80.000000, 80.000000) * millimeter, vector(0.000000, 80.000000) * millimeter, vector(-10.000000, 78.000000) * millimeter, vector(-10.000000, -2.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1);
