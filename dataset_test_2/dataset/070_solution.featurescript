...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(210.000000, 0.000000) * millimeter, vector(210.000000, 80.000000) * millimeter, vector(0.000000, 80.000000) * millimeter, vector(-27.522900, 90.000000) * millimeter, vector(-27.522900, 100.000000) * millimeter, vector(-58.461500, 100.000000) * millimeter, vector(-58.461500, 90.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(86.758921, 43.224560, 0.000000) * millimeter),
