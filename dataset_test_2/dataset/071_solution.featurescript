...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        // Flange 0->1_0_2: bend=95.68deg, zone=10mm
        ...
        var wallFace1_0_2a = qClosestTo(qCreatedBy(id + "flange0_1_0_2a", EntityType.FACE), vector(-10.495098, 40.000000, 4.975427) * millimeter);
        var faceN1_0_2a = evPlane(context, { "face" : wallFace1_0_2a }).normal;
        var skN1_0_2a = dot(faceN1_0_2a, vector(-0.995085488, 0.0, -0.099019551)) >= 0 ? faceN1_0_2a : -faceN1_0_2a;
        var sketchRem1_0_2a = newSketchOnPlane(context, id + "sketchRem1_0_2a", { "sketchPlane" : plane(vector(-10.9902, 80.0, 9.9509) * millimeter, skN1_0_2a, vector(0.099019551, 0.0, -0.995085488)) });
        skPolyline(sketchRem1_0_2a, "polyRem1_0_2a", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(8.000045, 0.000000) * millimeter, vector(8.000045, 80.000000) * millimeter, vector(0.000000, 80.000000) * millimeter, vector(-107.331650, -10.000000) * millimeter, vector(-105.331650, -20.000000) * millimeter, vector(-19.832890, -20.000000) * millimeter, vector(-21.832890, -10.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1_0_2a);
        sheetMetalTab(context, id + "smTab1_0_2a", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem1_0_2a"), vector(-10.495098, 80.000000, 4.975427) * millimeter),
            "booleanUnionScope" : wallFace1_0_2a,
            "booleanOffset" : 0.0 * millimeter
        });
        // Flange 1_0_2->2: bend=90.00deg, zone=10mm
        sheetMetalFlange(context, id + "flange1_0_2_2b", {
            "edges" : qClosestTo(qOwnedByBody(qBodyType(qCreatedBy(id + "smStart0", EntityType.BODY), BodyType.SOLID), EntityType.EDGE), vector(-17.384900, 100.000000, 74.215800) * millimeter),
            "angleControlType" : SMFlangeAngleControlType.BEND_ANGLE,
            "bendAngle" : 90.000000 * degree,
            "limitType" : SMFlangeBoundingType.BLIND,
            "distance" : 10.000000 * millimeter,
        ...
        var sketchRem2b = newSketchOnPlane(context, id + "sketchRem2b", { "sketchPlane" : plane(vector(-30.0, 100.0, 30.0) * millimeter, vector(0.0, -1.0, 0.0), vector(0.995085782, 0.0, 0.0990165971)) });
        skPolyline(sketchRem2b, "polyRem2b", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(14.931207, 0.000030) * millimeter, vector(14.931203, 85.498790) * millimeter, vector(6.931157, 85.498760) * millimeter, vector(-152.282563, 85.498660) * millimeter, vector(-159.213725, 15.842656) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2b);
        sheetMetalTab(context, id + "smTab2b", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem2b"), vector(-22.360329, 100.000000, 73.720717) * millimeter),
            "booleanUnionScope" : qClosestTo(qCreatedBy(id + "flange1_0_2_2b", EntityType.FACE), vector(-22.360329, 100.000000, 73.720717) * millimeter),
            "booleanOffset" : 0.0 * millimeter
        });
    });