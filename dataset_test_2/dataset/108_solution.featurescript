...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(2.000000, -10.000000) * millimeter, vector(2.000000, -18.000000) * millimeter, vector(-48.000000, -18.000000) * millimeter, vector(-48.000000, -10.000000) * millimeter, vector(-70.000000, 0.000000) * millimeter, vector(-80.000000, -2.000000) * millimeter, vector(-80.000000, 78.000000) * millimeter, vector(-70.000000, 80.000000) * millimeter, vector(0.000000, 80.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2);
