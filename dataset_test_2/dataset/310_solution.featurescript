...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(100.000000, 0.000000) * millimeter, vector(120.000000, -3.033700) * millimeter, vector(130.000000, -5.033700) * millimeter, vector(130.000000, 40.941200) * millimeter, vector(120.000000, 42.941200) * millimeter, vector(100.000000, 80.000000) * millimeter, vector(0.000000, 80.000000) * millimeter, vector(-32.000000, -10.000000) * millimeter, vector(-32.000000, -18.000000) * millimeter, vector(13.793100, -18.000000) * millimeter, vector(13.793100, -10.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2);
