...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(-67.400000, -32.000000) * millimeter, vector(-67.400000, -40.000000) * millimeter, vector(-193.200000, -40.000000) * millimeter, vector(-193.200000, -32.000000) * millimeter, vector(-252.000000, 0.000000) * millimeter, vector(-252.000000, 482.000000) * millimeter, vector(0.000000, 482.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2);
