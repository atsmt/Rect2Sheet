...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(27.586200, -40.000000) * millimeter, vector(27.586200, -48.000000) * millimeter, vector(172.413800, -48.000000) * millimeter, vector(172.413800, -40.000000) * millimeter, vector(200.000000, 0.000000) * millimeter, vector(240.000000, 5.000000) * millimeter, vector(250.000000, 3.000000) * millimeter, vector(250.000000, 77.117600) * millimeter, vector(240.000000, 79.117600) * millimeter, vector(200.000000, 160.000000) * millimeter, vector(0.000000, 160.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2);
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(-120.000000, 0.000000) * millimeter, vector(-120.000000, 70.000000) * millimeter, vector(20.000000, 99.117600) * millimeter, vector(28.000000, 99.117600) * millimeter, vector(28.000000, 25.000000) * millimeter, vector(20.000000, 25.000000) * millimeter, vector(0.000000, 70.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1);
        sheetMetalTab(context, id + "smTab1", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem1"), vector(-50.000000, -15.000000, 92.058800) * millimeter),
            "booleanUnionScope" : qClosestTo(qCreatedBy(id + "flange2_1", EntityType.FACE), vector(-50.000000, -15.000000, 92.058800) * millimeter),
            "booleanOffset" : 0.0 * millimeter
        });
    });