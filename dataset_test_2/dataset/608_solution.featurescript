...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(-36.000000, -20.000000) * millimeter, vector(-36.000000, -28.000000) * millimeter, vector(-64.000000, -28.000000) * millimeter, vector(-64.000000, -20.000000) * millimeter, vector(-100.000000, 0.000000) * millimeter, vector(-100.000000, 212.000000) * millimeter, vector(0.000000, 212.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2);
        ...
        // Flange 2->1_2_3: bend=26.56deg, zone=10mm
        sheetMetalFlange(context, id + "flange2_1_2_3a", {
            "edges" : qClosestTo(qOwnedByBody(qBodyType(qCreatedBy(id + "smStart0", EntityType.BODY), BodyType.SOLID), EntityType.EDGE), vector(-120.000000, 110.000000, -240.000000) * millimeter),
            "angleControlType" : SMFlangeAngleControlType.BEND_ANGLE,
        ...
        var wallFace1_2_3a = qClosestTo(qCreatedBy(id + "flange2_1_2_3a", EntityType.FACE), vector(-120.000000, 112.236048, -244.472146) * millimeter);
        var faceN1_2_3a = evPlane(context, { "face" : wallFace1_2_3a }).normal;
        var skN1_2_3a = dot(faceN1_2_3a, vector(0.0, -0.894429191, -0.4472095955)) >= 0 ? faceN1_2_3a : -faceN1_2_3a;
        var sketchRem1_2_3a = newSketchOnPlane(context, id + "sketchRem1_2_3a", { "sketchPlane" : plane(vector(-70.0, 114.4721, -248.9443) * millimeter, skN1_2_3a, vector(0.0, -0.4472095955, 0.894429191)) });
        skPolyline(sketchRem1_2_3a, "polyRem1_2_3a", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(8.000009, 0.000000) * millimeter, vector(8.000009, 100.000000) * millimeter, vector(0.000000, 100.000000) * millimeter, vector(-2.360662, 90.000000) * millimeter, vector(-10.360671, 90.000000) * millimeter, vector(-10.360671, 10.000000) * millimeter, vector(-2.360662, 10.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1_2_3a);
        sheetMetalTab(context, id + "smTab1_2_3a", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem1_2_3a"), vector(-70.000000, 112.236048, -244.472146) * millimeter),
            "booleanUnionScope" : wallFace1_2_3a,
            "booleanOffset" : 0.0 * millimeter
        });
        // Flange 1_2_3->3: bend=116.56deg, zone=10mm
        ...
        var wallFace3b = qClosestTo(qCreatedBy(id + "flange1_2_3_3b", EntityType.FACE), vector(-120.000000, 125.000000, -260.000000) * millimeter);
