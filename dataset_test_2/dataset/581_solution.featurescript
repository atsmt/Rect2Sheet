...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(44.431300, -51.000000) * millimeter, vector(44.431300, -59.000000) * millimeter, vector(127.568700, -59.000000) * millimeter, vector(127.568700, -51.000000) * millimeter, vector(172.000000, 0.000000) * millimeter, vector(172.000000, 147.000000) * millimeter, vector(-51.000000, 147.000000) * millimeter, vector(-61.000000, 145.000000) * millimeter, vector(-61.000000, -2.000000) * millimeter, vector(-51.000000, 0.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1);
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(0.000000, -59.000000) * millimeter, vector(147.000000, -59.000000) * millimeter, vector(147.000000, 221.000000) * millimeter, vector(0.000000, 221.000000) * millimeter, vector(-26.000000, 132.395700) * millimeter, vector(-36.000000, 130.395700) * millimeter, vector(-36.000000, -4.844500) * millimeter, vector(-26.000000, -2.844500) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2);
        ...
        skPolyline(sketchRem3, "polyRem3", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(223.000000, -254.395700) * millimeter, vector(231.000000, -254.395700) * millimeter, vector(231.000000, -119.155500) * millimeter, vector(223.000000, -119.155500) * millimeter, vector(172.000000, 0.000000) * millimeter, vector(172.000000, 86.000000) * millimeter, vector(0.000000, 86.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem3);
        sheetMetalTab(context, id + "smTab3", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem3"), vector(-56.000000, 358.775600, 244.000000) * millimeter),
            "booleanUnionScope" : qClosestTo(qCreatedBy(id + "flange2_3", EntityType.FACE), vector(-56.000000, 358.775600, 244.000000) * millimeter),
            "booleanOffset" : 0.0 * millimeter
        });
    });