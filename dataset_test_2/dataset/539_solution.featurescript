...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem2b, "polyRem2b", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(0.000000, -8.000000) * millimeter, vector(100.000000, -8.000000) * millimeter, vector(100.000000, 160.000000) * millimeter, vector(-30.000000, 160.000000) * millimeter, vector(-40.000000, 158.000000) * millimeter, vector(-40.000000, -2.000000) * millimeter, vector(-30.000000, 0.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2b);
        ...
        var wallFace1 = qClosestTo(qCreatedBy(id + "flange2_1", EntityType.FACE), vector(-20.000000, 165.000000, -120.000000) * millimeter);
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(140.000000, 0.000000) * millimeter, vector(140.000000, 180.000000) * millimeter, vector(-12.000000, 180.000000) * millimeter, vector(-12.000000, 0.000000) * millimeter, vector(140.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1);
        sheetMetalTab(context, id + "smTab1", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem1"), vector(-20.000000, 165.000000, -30.000000) * millimeter),
