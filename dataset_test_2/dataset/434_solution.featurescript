...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(0.000000, -48.000000) * millimeter, vector(120.000000, -48.000000) * millimeter, vector(120.000000, 0.000000) * millimeter, vector(150.000000, 8.000000) * millimeter, vector(160.000000, 6.000000) * millimeter, vector(160.000000, 134.000000) * millimeter, vector(150.000000, 136.000000) * millimeter, vector(120.000000, 160.000000) * millimeter, vector(0.000000, 160.000000) * millimeter, vector(0.000000, -48.000000) * millimeter] });
        skSolve(sketchRem2);
