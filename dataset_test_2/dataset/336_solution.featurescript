...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(38.243900, -60.000000) * millimeter, vector(38.243900, -68.000000) * millimeter, vector(85.975600, -68.000000) * millimeter, vector(85.975600, -60.000000) * millimeter, vector(98.000000, 0.000000) * millimeter, vector(98.000000, 169.000000) * millimeter, vector(0.000000, 169.000000) * millimeter, vector(-10.000000, 171.000000) * millimeter, vector(-10.000000, 2.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2);
