...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(-72.000000, -20.000000) * millimeter, vector(-72.000000, -28.000000) * millimeter, vector(-128.000000, -28.000000) * millimeter, vector(-128.000000, -20.000000) * millimeter, vector(-200.000000, 0.000000) * millimeter, vector(-200.000000, 80.000000) * millimeter, vector(0.000000, 80.000000) * millimeter, vector(10.000000, 78.000000) * millimeter, vector(10.000000, -2.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1);
