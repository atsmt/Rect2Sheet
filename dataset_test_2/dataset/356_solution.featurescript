...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(210.000000, 0.000000) * millimeter, vector(210.000000, 200.000000) * millimeter, vector(200.000000, 200.000000) * millimeter, vector(220.000000, 218.493200) * millimeter, vector(230.000000, 218.493200) * millimeter, vector(230.000000, 262.445200) * millimeter, vector(220.000000, 262.445200) * millimeter, vector(0.000000, 200.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(88.507896, 117.750773, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(-70.000000, 0.000000) * millimeter, vector(-70.000000, 80.000000) * millimeter, vector(0.000000, 80.000000) * millimeter, vector(70.000000, -7.554800) * millimeter, vector(78.000000, -7.554800) * millimeter, vector(78.000000, -51.506800) * millimeter, vector(70.000000, -51.506800) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2);
        sheetMetalTab(context, id + "smTab2", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem2"), vector(-30.000000, 240.469200, -5.000000) * millimeter),
            "booleanUnionScope" : qClosestTo(qCreatedBy(id + "flange0_2", EntityType.FACE), vector(-30.000000, 240.469200, -5.000000) * millimeter),
            "booleanOffset" : 0.0 * millimeter
        });
    });