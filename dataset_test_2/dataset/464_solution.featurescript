...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(379.000000, 0.000000) * millimeter, vector(379.000000, 147.000000) * millimeter, vector(377.392000, 221.000000) * millimeter, vector(377.392000, 231.000000) * millimeter, vector(269.600000, 231.000000) * millimeter, vector(269.600000, 221.000000) * millimeter, vector(0.000000, 147.000000) * millimeter, vector(-10.000000, 147.000000) * millimeter, vector(-10.000000, 0.000000) * millimeter, vector(379.000000, 0.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(200.528153, 100.126608, 0.000000) * millimeter),
        ...
        sheetMetalFlange(context, id + "flange0_2", {
            "edges" : qClosestTo(qOwnedByBody(qBodyType(qCreatedBy(id + "smStart0", EntityType.BODY), BodyType.SOLID), EntityType.EDGE), vector(323.496000, 231.000000, 0.000000) * millimeter),
            "angleControlType" : SMFlangeAngleControlType.BEND_ANGLE,
            "bendAngle" : 90.000000 * degree,
            "limitType" : SMFlangeBoundingType.BLIND,
            "distance" : 10.000000 * millimeter,
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(252.000000, 0.000000) * millimeter, vector(252.000000, 379.000000) * millimeter, vector(217.241400, 474.000000) * millimeter, vector(217.241400, 482.000000) * millimeter, vector(34.758600, 482.000000) * millimeter, vector(34.758600, 474.000000) * millimeter, vector(0.000000, 379.000000) * millimeter, vector(-40.392000, -32.000000) * millimeter, vector(-40.392000, -40.000000) * millimeter, vector(67.400000, -40.000000) * millimeter, vector(67.400000, -32.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2);
        sheetMetalTab(context, id + "smTab2", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem2"), vector(323.496000, 231.000000, 5.000000) * millimeter),
            "booleanUnionScope" : qClosestTo(qCreatedBy(id + "flange0_2", EntityType.FACE), vector(323.496000, 231.000000, 5.000000) * millimeter),
            "booleanOffset" : 0.0 * millimeter
        });
