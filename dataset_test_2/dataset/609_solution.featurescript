...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(-170.000000, 0.000000) * millimeter, vector(-170.000000, 110.000000) * millimeter, vector(-70.000000, 110.000000) * millimeter, vector(-70.000000, 70.000000) * millimeter, vector(200.000000, 70.000000) * millimeter, vector(200.000000, 0.000000) * millimeter, vector(-170.000000, 0.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(-3.060201, 42.357860, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(0.000000, -28.000000) * millimeter, vector(100.000000, -28.000000) * millimeter, vector(100.000000, 200.000000) * millimeter, vector(93.076900, 220.000000) * millimeter, vector(93.076900, 228.000000) * millimeter, vector(6.923100, 228.000000) * millimeter, vector(6.923100, 220.000000) * millimeter, vector(0.000000, 200.000000) * millimeter, vector(0.000000, -28.000000) * millimeter] });
        skSolve(sketchRem2);
