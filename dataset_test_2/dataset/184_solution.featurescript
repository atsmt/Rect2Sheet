...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(0.000000, 339.000000) * millimeter, vector(293.000000, 339.000000) * millimeter, vector(293.000000, 0.000000) * millimeter, vector(0.000000, 0.000000) * millimeter, vector(0.000000, 339.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(146.500000, 169.500000, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem1b, "polyRem1b", { "points" : [vector(0.000000, -8.000000) * millimeter, vector(293.000000, -8.000000) * millimeter, vector(293.000000, 0.000000) * millimeter, vector(297.093600, -63.000000) * millimeter, vector(297.093600, -75.000000) * millimeter, vector(357.082600, -75.000000) * millimeter, vector(357.082600, -63.000000) * millimeter, vector(293.000000, 146.000000) * millimeter, vector(0.000000, 146.000000) * millimeter, vector(0.000000, -8.000000) * millimeter] });
        skSolve(sketchRem1b);
