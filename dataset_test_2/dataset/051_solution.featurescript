...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(80.000000, 120.000000) * millimeter, vector(80.000000, -10.000000) * millimeter, vector(0.000000, -10.000000) * millimeter, vector(0.000000, 0.000000) * millimeter, vector(-170.000000, 0.000000) * millimeter, vector(-170.000000, 130.000000) * millimeter, vector(-70.000000, 130.000000) * millimeter, vector(-70.000000, 120.000000) * millimeter, vector(80.000000, 120.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(125.220126, 60.408805, 0.000000) * millimeter),
        ...
        sheetMetalFlange(context, id + "flange1_0_3_3b", {
            "edges" : qClosestTo(qOwnedByBody(qBodyType(qCreatedBy(id + "smStart0", EntityType.BODY), BodyType.SOLID), EntityType.EDGE), vector(-30.000000, -10.000000, 85.000000) * millimeter),
            "angleControlType" : SMFlangeAngleControlType.BEND_ANGLE,
            "bendAngle" : 90.000000 * degree,
            "limitType" : SMFlangeBoundingType.BLIND,
            "distance" : 10.000000 * millimeter,
        ...
        sheetMetalTab(context, id + "smTab3b", {
            ...
            "booleanUnionScope" : qClosestTo(qCreatedBy(id + "flange1_0_3_3b", EntityType.FACE), vector(-30.000000, -5.000000, 85.000000) * millimeter),
            "booleanOffset" : 0.0 * millimeter
        });
