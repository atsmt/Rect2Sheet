...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        sheetMetalFlange(context, id + "flange3_2", {
            "edges" : qClosestTo(qOwnedByBody(qBodyType(qCreatedBy(id + "smStart0", EntityType.BODY), BodyType.SOLID), EntityType.EDGE), vector(177.250000, -75.000000, -0.000100) * millimeter),
            "angleControlType" : SMFlangeAngleControlType.BEND_ANGLE,
        ...
        var wallFace2 = qClosestTo(qCreatedBy(id + "flange3_2", EntityType.FACE), vector(177.250000, -77.166455, -4.506370) * millimeter);
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(-44.999900, -64.999980) * millimeter, vector(-44.999900, -72.999939) * millimeter, vector(219.499900, -72.999939) * millimeter, vector(219.499900, -64.999980) * millimeter, vector(151.000000, 0.000000) * millimeter, vector(151.000000, 377.999964) * millimeter, vector(0.000000, 377.999964) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2);
        sheetMetalTab(context, id + "smTab2", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem2"), vector(177.250000, -107.496802, -67.594099) * millimeter),
