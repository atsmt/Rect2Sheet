...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(-72.000000, -20.000000) * millimeter, vector(-72.000000, -28.000000) * millimeter, vector(-128.000000, -28.000000) * millimeter, vector(-128.000000, -20.000000) * millimeter, vector(-200.000000, 0.000000) * millimeter, vector(-200.000000, 80.000000) * millimeter, vector(-144.667000, 90.000000) * millimeter, vector(-144.667000, 98.000000) * millimeter, vector(-55.333000, 98.000000) * millimeter, vector(-55.333000, 90.000000) * millimeter, vector(0.000000, 80.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1);
