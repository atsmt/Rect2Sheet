...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(200.000000, 0.000000) * millimeter, vector(302.975300, 116.598300) * millimeter, vector(307.738200, 125.391200) * millimeter, vector(206.625100, 180.161300) * millimeter, vector(201.862200, 171.368400) * millimeter, vector(200.000000, 160.000000) * millimeter, vector(129.756100, 190.000000) * millimeter, vector(129.756100, 200.000000) * millimeter, vector(54.634100, 200.000000) * millimeter, vector(54.634100, 190.000000) * millimeter, vector(0.000000, 160.000000) * millimeter, vector(-20.000000, 117.647100) * millimeter, vector(-30.000000, 117.647100) * millimeter, vector(-30.000000, 42.352900) * millimeter, vector(-20.000000, 42.352900) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(119.988482, 93.832317, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem3, "polyRem3", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(80.000000, 0.000000) * millimeter, vector(80.000000, 139.999977) * millimeter, vector(0.000000, 139.999977) * millimeter, vector(-40.000000, 136.647024) * millimeter, vector(-48.000000, 136.647024) * millimeter, vector(-48.000000, 21.653012) * millimeter, vector(-40.000000, 21.653012) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem3);
