...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem2b, "polyRem2b", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(20.000000, -30.000000) * millimeter, vector(22.000000, -40.000000) * millimeter, vector(82.000000, -40.000000) * millimeter, vector(80.000000, -30.000000) * millimeter, vector(100.000000, 0.000000) * millimeter, vector(108.000000, 0.000000) * millimeter, vector(108.000000, 200.000000) * millimeter, vector(-8.000000, 200.000000) * millimeter, vector(-8.000000, 0.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2b);
