...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(-32.367424, 104.325758, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem3, "polyRem3", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(-24.000000, -10.000000) * millimeter, vector(-24.000000, -18.000000) * millimeter, vector(-64.000000, -18.000000) * millimeter, vector(-64.000000, -10.000000) * millimeter, vector(-80.000000, 0.000000) * millimeter, vector(-140.000000, 7.538500) * millimeter, vector(-150.000000, 5.538500) * millimeter, vector(-150.000000, 155.384600) * millimeter, vector(-140.000000, 157.384600) * millimeter, vector(-80.000000, 180.000000) * millimeter, vector(0.000000, 180.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem3);
