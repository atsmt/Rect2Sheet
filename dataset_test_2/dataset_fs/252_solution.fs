...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem3, "polyRem3", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(-24.000000, -10.000000) * millimeter, vector(-24.000000, -18.000000) * millimeter, vector(-64.000000, -18.000000) * millimeter, vector(-64.000000, -10.000000) * millimeter, vector(-80.000000, 0.000000) * millimeter, vector(-140.000000, 51.846200) * millimeter, vector(-150.000000, 49.846200) * millimeter, vector(-150.000000, 111.076900) * millimeter, vector(-140.000000, 113.076900) * millimeter, vector(-80.000000, 180.000000) * millimeter, vector(0.000000, 180.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem3);
