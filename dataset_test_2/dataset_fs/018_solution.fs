...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem3, "polyRem3", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(-160.000000, 0.000000) * millimeter, vector(-180.000000, -2.647100) * millimeter, vector(-188.000000, -2.647100) * millimeter, vector(-188.000000, 109.117600) * millimeter, vector(-180.000000, 109.117600) * millimeter, vector(-160.000000, 80.000000) * millimeter, vector(0.000000, 80.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem3);
