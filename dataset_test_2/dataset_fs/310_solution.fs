...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(200.000000, 0.000000) * millimeter, vector(200.000000, 160.000000) * millimeter, vector(220.146400, 161.464300) * millimeter, vector(224.909300, 170.257200) * millimeter, vector(166.903900, 201.677100) * millimeter, vector(162.141000, 192.884200) * millimeter, vector(0.000000, 160.000000) * millimeter, vector(-20.000000, 117.647100) * millimeter, vector(-30.000000, 117.647100) * millimeter, vector(-30.000000, 42.352900) * millimeter, vector(-20.000000, 42.352900) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(95.267341, 90.122342, 0.000000) * millimeter),
        ...
        sheetMetalFlange(context, id + "flange0_3", {
            "edges" : qClosestTo(qOwnedByBody(qBodyType(qCreatedBy(id + "smStart0", EntityType.BODY), BodyType.SOLID), EntityType.EDGE), vector(195.906600, 185.967150, 0.000000) * millimeter),
            "angleControlType" : SMFlangeAngleControlType.BEND_ANGLE,
            "bendAngle" : 90.000000 * degree,
            "limitType" : SMFlangeBoundingType.BLIND,
            "distance" : 10.000000 * millimeter,
        ...
        skPolyline(sketchRem3, "polyRem3", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(80.000000, 0.000000) * millimeter, vector(80.000000, 139.999977) * millimeter, vector(0.000000, 139.999977) * millimeter, vector(-40.000000, 42.447318) * millimeter, vector(-48.000000, 42.447318) * millimeter, vector(-48.000000, -23.521133) * millimeter, vector(-40.000000, -23.521133) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem3);
        sheetMetalTab(context, id + "smTab3", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem3"), vector(195.906600, 185.967150, 5.000000) * millimeter),
            "booleanUnionScope" : qClosestTo(qCreatedBy(id + "flange0_3", EntityType.FACE), vector(195.906600, 185.967150, 5.000000) * millimeter),
            "booleanOffset" : 0.0 * millimeter
        });
