...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(379.000000, 0.000000) * millimeter, vector(379.000000, 147.000000) * millimeter, vector(269.600000, 221.000000) * millimeter, vector(269.600000, 231.000000) * millimeter, vector(143.800000, 231.000000) * millimeter, vector(143.800000, 221.000000) * millimeter, vector(0.000000, 147.000000) * millimeter, vector(-10.000000, 147.000000) * millimeter, vector(-10.000000, 0.000000) * millimeter, vector(379.000000, 0.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(187.807722, 101.251751, 0.000000) * millimeter),
