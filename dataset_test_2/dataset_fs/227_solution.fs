...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(116.000000, 0.000000) * millimeter, vector(116.000000, 185.000000) * millimeter, vector(0.000000, 185.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(58.000000, 92.500000, 0.000000) * millimeter),
        ...
        var wallFace1_0_1a = qClosestTo(qCreatedBy(id + "flange0_1_0_1a", EntityType.FACE), vector(58.000000, 188.535534, 3.535534) * millimeter);
        ...
        var sketchRem1_0_1a = newSketchOnPlane(context, id + "sketchRem1_0_1a", { "sketchPlane" : plane(vector(0.0, 192.0711, 7.0711) * millimeter, skN1_0_1a, vector(0.0, -0.7071067812, -0.7071067812)) });
        ...
        sheetMetalTab(context, id + "smTab1_0_1a", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem1_0_1a"), vector(0.000000, 188.535534, 3.535534) * millimeter),
        ...
        var wallFace1b = qClosestTo(qCreatedBy(id + "flange1_0_1_1b", EntityType.FACE), vector(51.000000, 204.000000, 24.000000) * millimeter);
        ...
        skPolyline(sketchRem1b, "polyRem1b", { "points" : [vector(0.000000, -8.000000) * millimeter, vector(102.000000, -8.000000) * millimeter, vector(102.000000, 262.000000) * millimeter, vector(0.000000, 262.000000) * millimeter, vector(0.000000, -8.000000) * millimeter] });
        skSolve(sketchRem1b);
