...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(100.000000, 0.000000) * millimeter, vector(0.000000, 0.000000) * millimeter, vector(0.000000, 420.000000) * millimeter, vector(100.000000, 420.000000) * millimeter, vector(100.000000, 380.000000) * millimeter, vector(140.000000, 329.310300) * millimeter, vector(150.000000, 329.310300) * millimeter, vector(150.000000, 267.931000) * millimeter, vector(140.000000, 267.931000) * millimeter, vector(100.000000, 200.000000) * millimeter, vector(100.000000, 0.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(58.018849, 219.654050, 0.000000) * millimeter),
        ...
        sheetMetalFlange(context, id + "flange1_2", {
            "edges" : qClosestTo(qOwnedByBody(qBodyType(qCreatedBy(id + "smStart0", EntityType.BODY), BodyType.SOLID), EntityType.EDGE), vector(150.000000, 298.620650, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(-20.689700, -10.000000) * millimeter, vector(-20.689700, -18.000000) * millimeter, vector(-82.069000, -18.000000) * millimeter, vector(-82.069000, -10.000000) * millimeter, vector(-100.000000, 0.000000) * millimeter, vector(-100.000000, 120.000000) * millimeter, vector(0.000000, 120.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2);
        sheetMetalTab(context, id + "smTab2", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem2"), vector(150.000000, 298.620650, -5.000000) * millimeter),
            "booleanUnionScope" : qClosestTo(qCreatedBy(id + "flange1_2", EntityType.FACE), vector(150.000000, 298.620650, -5.000000) * millimeter),
