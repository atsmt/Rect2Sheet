...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(210.000000, 0.000000) * millimeter, vector(210.000000, 200.000000) * millimeter, vector(200.000000, 200.000000) * millimeter, vector(220.000000, 208.630100) * millimeter, vector(230.000000, 208.630100) * millimeter, vector(230.000000, 333.811100) * millimeter, vector(220.000000, 333.811100) * millimeter, vector(0.000000, 200.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(81.971196, 140.319979, 0.000000) * millimeter),
