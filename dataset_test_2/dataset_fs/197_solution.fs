...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(0.000000, -46.000000) * millimeter, vector(85.000000, -46.000000) * millimeter, vector(85.000000, 0.000000) * millimeter, vector(95.000000, -2.000000) * millimeter, vector(95.000000, 83.000000) * millimeter, vector(85.000000, 85.000000) * millimeter, vector(0.000000, 85.000000) * millimeter, vector(0.000000, -46.000000) * millimeter] });
        skSolve(sketchRem1);
        ...
        skPolyline(sketchRem2b, "polyRem2b", { "points" : [vector(-107.000000, 0.000000) * millimeter, vector(-107.000000, 85.000000) * millimeter, vector(8.000000, 85.000000) * millimeter, vector(8.000000, 0.000000) * millimeter, vector(-107.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2b);
        sheetMetalTab(context, id + "smTab2b", {
            ...
            "booleanUnionScope" : qClosestTo(qCreatedBy(id + "flange1_1_2_2b", EntityType.FACE), vector(90.000000, 18.500000, 157.000000) * millimeter),
            "booleanOffset" : 0.0 * millimeter
        });
        ...
        skPolyline(sketchRem3, "polyRem3", { "points" : [vector(0.000000, -46.000000) * millimeter, vector(85.000000, -46.000000) * millimeter, vector(85.000000, 97.000000) * millimeter, vector(0.000000, 97.000000) * millimeter, vector(0.000000, -46.000000) * millimeter] });
        skSolve(sketchRem3);
