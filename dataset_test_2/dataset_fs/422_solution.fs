...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(120.000000, 0.000000) * millimeter, vector(120.000000, 100.000000) * millimeter, vector(96.000000, 130.000000) * millimeter, vector(96.000000, 140.000000) * millimeter, vector(8.000000, 140.000000) * millimeter, vector(8.000000, 130.000000) * millimeter, vector(0.000000, 100.000000) * millimeter, vector(-10.000000, 100.000000) * millimeter, vector(-10.000000, 0.000000) * millimeter, vector(120.000000, 0.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(64.934118, 66.188235, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem1_0, "polyRem1_0", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(2.000000, -10.000000) * millimeter, vector(2.000000, -18.000000) * millimeter, vector(-86.000000, -18.000000) * millimeter, vector(-86.000000, -10.000000) * millimeter, vector(-80.000000, 0.000000) * millimeter, vector(-80.000000, 55.000000) * millimeter, vector(0.000000, 55.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
