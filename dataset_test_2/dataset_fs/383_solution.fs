...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(408.000000, 32.000000) * millimeter, vector(278.000000, 0.000000) * millimeter, vector(0.000000, 0.000000) * millimeter, vector(0.000000, 167.000000) * millimeter, vector(278.000000, 167.000000) * millimeter, vector(408.000000, 149.000000) * millimeter, vector(686.000000, 149.000000) * millimeter, vector(686.000000, -10.000000) * millimeter, vector(418.000000, -10.000000) * millimeter, vector(418.000000, 32.000000) * millimeter, vector(408.000000, 32.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(337.906388, 78.645216, 0.000000) * millimeter),
