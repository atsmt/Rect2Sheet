...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(-119.117600, -65.000000) * millimeter, vector(-119.117600, -73.000000) * millimeter, vector(-330.882400, -73.000000) * millimeter, vector(-330.882400, -65.000000) * millimeter, vector(-450.000000, 0.000000) * millimeter, vector(-450.000000, 200.000000) * millimeter, vector(0.000000, 200.000000) * millimeter, vector(10.000000, 198.000000) * millimeter, vector(10.000000, -2.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1);
        ...
        var sketchRem1_1_2a = newSketchOnPlane(context, id + "sketchRem1_1_2a", { "sketchPlane" : plane(vector(535.0, -10.0, 75.0) * millimeter, vector(0.0, 1.0, 0.0), vector(-1.0, 0.0, 0.0)) });
        ...
        sheetMetalTab(context, id + "smTab1_1_2a", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem1_1_2a"), vector(530.000000, -10.000000, 175.000000) * millimeter),
            "booleanUnionScope" : qClosestTo(qCreatedBy(id + "flange1_1_1_2a", EntityType.FACE), vector(530.000000, -10.000000, 175.000000) * millimeter),
            "booleanOffset" : 0.0 * millimeter
        });
        ...
        sheetMetalTab(context, id + "smTab2b", {
            ...
            "booleanUnionScope" : qClosestTo(qCreatedBy(id + "flange1_1_2_2b", EntityType.FACE), vector(725.000000, -5.000000, 25.000000) * millimeter),
            "booleanOffset" : 0.0 * millimeter
        });
    });