...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem3, "polyRem3", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(58.048800, -40.000000) * millimeter, vector(58.048800, -48.000000) * millimeter, vector(109.756100, -48.000000) * millimeter, vector(109.756100, -40.000000) * millimeter, vector(180.000000, 0.000000) * millimeter, vector(180.000000, 160.000000) * millimeter, vector(0.000000, 160.000000) * millimeter, vector(-270.196900, -40.000000) * millimeter, vector(-270.196900, -52.000000) * millimeter, vector(-60.975600, -52.000000) * millimeter, vector(-60.975600, -40.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem3);
