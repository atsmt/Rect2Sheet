...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(16.000000, -30.000000) * millimeter, vector(16.000000, -38.000000) * millimeter, vector(144.000000, -38.000000) * millimeter, vector(144.000000, -30.000000) * millimeter, vector(160.000000, 0.000000) * millimeter, vector(160.000000, 120.000000) * millimeter, vector(0.000000, 120.000000) * millimeter, vector(-30.000000, 96.000000) * millimeter, vector(-40.000000, 94.000000) * millimeter, vector(-40.000000, -10.000000) * millimeter, vector(-30.000000, -8.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1);
