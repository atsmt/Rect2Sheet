...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(200.000000, 0.000000) * millimeter, vector(200.000000, 160.000000) * millimeter, vector(129.756100, 190.000000) * millimeter, vector(129.756100, 200.000000) * millimeter, vector(54.634100, 200.000000) * millimeter, vector(54.634100, 190.000000) * millimeter, vector(0.000000, 160.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(99.470382, 92.719580, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(0.000000, -40.000000) * millimeter, vector(-2.000000, -50.000000) * millimeter, vector(-82.000000, -50.000000) * millimeter, vector(-80.000000, -40.000000) * millimeter, vector(-80.000000, 0.000000) * millimeter, vector(-120.000000, 34.634100) * millimeter, vector(-128.000000, 34.634100) * millimeter, vector(-128.000000, 109.756100) * millimeter, vector(-120.000000, 109.756100) * millimeter, vector(-80.000000, 120.000000) * millimeter, vector(-80.000000, 140.000100) * millimeter, vector(-82.000000, 150.000100) * millimeter, vector(-2.000000, 150.000100) * millimeter, vector(0.000000, 140.000100) * millimeter, vector(0.000000, -40.000000) * millimeter] });
        skSolve(sketchRem2);
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(160.000000, 0.000000) * millimeter, vector(160.000000, 80.000000) * millimeter, vector(-38.000000, 80.000000) * millimeter, vector(-38.000000, 0.000000) * millimeter, vector(160.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1);
        sheetMetalTab(context, id + "smTab1", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem1"), vector(-30.000000, 195.000000, 90.000000) * millimeter),
            "booleanUnionScope" : qClosestTo(qCreatedBy(id + "flange2_1", EntityType.FACE), vector(-30.000000, 195.000000, 90.000000) * millimeter),
            "booleanOffset" : 0.0 * millimeter
        });
