...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(52.827600, -85.000000) * millimeter, vector(52.827600, -93.000000) * millimeter, vector(330.172400, -93.000000) * millimeter, vector(330.172400, -85.000000) * millimeter, vector(383.000000, 0.000000) * millimeter, vector(430.000000, 110.520000) * millimeter, vector(440.000000, 108.520000) * millimeter, vector(440.000000, 194.480000) * millimeter, vector(430.000000, 196.480000) * millimeter, vector(383.000000, 307.000000) * millimeter, vector(0.000000, 307.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1);
