...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem1b, "polyRem1b", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(98.000000, 0.000000) * millimeter, vector(98.000000, 80.000000) * millimeter, vector(80.000000, 80.000000) * millimeter, vector(58.823500, 120.000000) * millimeter, vector(60.823500, 130.000000) * millimeter, vector(23.176500, 130.000000) * millimeter, vector(21.176500, 120.000000) * millimeter, vector(0.000000, 80.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1b);
