...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(210.000000, 0.000000) * millimeter, vector(210.000000, 80.000000) * millimeter, vector(0.000000, 80.000000) * millimeter, vector(-9.230800, 90.000000) * millimeter, vector(-9.230800, 100.000000) * millimeter, vector(-174.311900, 100.000000) * millimeter, vector(-174.311900, 90.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(44.073635, 49.353664, 0.000000) * millimeter),
