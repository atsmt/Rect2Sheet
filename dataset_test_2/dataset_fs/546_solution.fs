...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(255.000000, -432.000000) * millimeter, vector(-10.000000, -432.000000) * millimeter, vector(-510.000000, -10.000000) * millimeter, vector(-510.000000, 357.000000) * millimeter, vector(-204.000000, 357.000000) * millimeter, vector(-87.000000, 201.817700) * millimeter, vector(-77.000000, 201.817700) * millimeter, vector(-77.000000, 155.790200) * millimeter, vector(-87.000000, 155.790200) * millimeter, vector(-204.000000, 0.000000) * millimeter, vector(-204.000000, -10.000000) * millimeter, vector(-10.000000, -254.000000) * millimeter, vector(255.000000, -254.000000) * millimeter, vector(255.000000, -432.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(-207.308655, -23.121514, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem3b, "polyRem3b", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(-130.182300, -92.000000) * millimeter, vector(-128.182300, -102.000000) * millimeter, vector(-174.209800, -102.000000) * millimeter, vector(-176.209800, -92.000000) * millimeter, vector(-306.000000, 0.000000) * millimeter, vector(-306.000000, 178.000000) * millimeter, vector(33.000000, 178.000000) * millimeter, vector(33.000000, 0.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem3b);
