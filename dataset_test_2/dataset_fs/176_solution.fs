...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem1b, "polyRem1b", { "points" : [vector(0.000000, -8.000000) * millimeter, vector(293.000000, -8.000000) * millimeter, vector(293.000000, 0.000000) * millimeter, vector(303.000000, -2.000000) * millimeter, vector(303.000000, 144.000000) * millimeter, vector(293.000000, 146.000000) * millimeter, vector(0.000000, 146.000000) * millimeter, vector(0.000000, -8.000000) * millimeter] });
        skSolve(sketchRem1b);
