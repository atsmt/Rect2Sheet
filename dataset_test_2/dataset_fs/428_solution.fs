...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem2b, "polyRem2b", { "points" : [vector(0.000000, -8.000000) * millimeter, vector(120.000000, -8.000000) * millimeter, vector(120.000000, 0.000000) * millimeter, vector(150.000000, -24.000000) * millimeter, vector(160.000000, -26.000000) * millimeter, vector(160.000000, 166.000000) * millimeter, vector(150.000000, 168.000000) * millimeter, vector(120.000000, 160.000000) * millimeter, vector(0.000000, 160.000000) * millimeter, vector(0.000000, -8.000000) * millimeter] });
        skSolve(sketchRem2b);
