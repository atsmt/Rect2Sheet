...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(120.000000, 0.000000) * millimeter, vector(120.000000, 100.000000) * millimeter, vector(72.000000, 130.000000) * millimeter, vector(72.000000, 140.000000) * millimeter, vector(32.000000, 140.000000) * millimeter, vector(32.000000, 130.000000) * millimeter, vector(0.000000, 100.000000) * millimeter, vector(-10.000000, 100.000000) * millimeter, vector(-10.000000, 0.000000) * millimeter, vector(120.000000, 0.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(64.822785, 61.645570, 0.000000) * millimeter),
