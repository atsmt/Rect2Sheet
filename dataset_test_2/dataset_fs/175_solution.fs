...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        var sketchRem1_0_1a = newSketchOnPlane(context, id + "sketchRem1_0_1a", { "sketchPlane" : plane(vector(400.0, -10.0, 10.0) * millimeter, vector(0.0, 1.0, 0.0), vector(0.0, 0.0, -1.0)) });
        skPolyline(sketchRem1_0_1a, "polyRem1_0_1a", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(8.000000, 0.000000) * millimeter, vector(8.000000, 400.000000) * millimeter, vector(0.000000, 400.000000) * millimeter, vector(-265.000000, -115.000000) * millimeter, vector(-263.000000, -125.000000) * millimeter, vector(-63.000000, -125.000000) * millimeter, vector(-65.000000, -115.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
