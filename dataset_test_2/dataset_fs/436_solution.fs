...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(594.000000, 275.000000) * millimeter, vector(594.000000, 0.000000) * millimeter, vector(0.000000, 0.000000) * millimeter, vector(0.000000, 343.000000) * millimeter, vector(275.000000, 343.000000) * millimeter, vector(275.000000, 275.000000) * millimeter, vector(594.000000, 275.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(280.616314, 155.116314, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(0.000000, -43.000000) * millimeter, vector(275.000000, -43.000000) * millimeter, vector(275.000000, 367.000000) * millimeter, vector(0.000000, 367.000000) * millimeter, vector(0.000000, -43.000000) * millimeter] });
        skSolve(sketchRem1);
