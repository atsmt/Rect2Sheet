...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(120.000000, 0.000000) * millimeter, vector(120.000000, 100.000000) * millimeter, vector(113.356400, 130.000000) * millimeter, vector(113.356400, 140.000000) * millimeter, vector(72.000000, 140.000000) * millimeter, vector(72.000000, 130.000000) * millimeter, vector(0.000000, 100.000000) * millimeter, vector(-10.000000, 100.000000) * millimeter, vector(-10.000000, 0.000000) * millimeter, vector(120.000000, 0.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(61.159791, 61.783391, 0.000000) * millimeter),
