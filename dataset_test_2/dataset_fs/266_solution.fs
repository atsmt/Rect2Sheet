...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(0.000000, -20.000000) * millimeter, vector(200.000000, -20.000000) * millimeter, vector(200.000000, 160.000000) * millimeter, vector(0.000000, 160.000000) * millimeter, vector(-38.117600, -10.000000) * millimeter, vector(-38.117600, -20.000000) * millimeter, vector(-12.413800, -20.000000) * millimeter, vector(-12.413800, -10.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(109.912545, 67.649560, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(0.000000, -48.000000) * millimeter, vector(200.000000, -48.000000) * millimeter, vector(200.000000, 0.000000) * millimeter, vector(240.000000, -14.705900) * millimeter, vector(250.000000, -16.705900) * millimeter, vector(250.000000, 77.117600) * millimeter, vector(240.000000, 79.117600) * millimeter, vector(200.000000, 160.000000) * millimeter, vector(0.000000, 160.000000) * millimeter, vector(0.000000, -48.000000) * millimeter] });
        skSolve(sketchRem2);
