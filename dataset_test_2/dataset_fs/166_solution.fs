...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(-119.117600, -65.000000) * millimeter, vector(-119.117600, -73.000000) * millimeter, vector(-330.882400, -73.000000) * millimeter, vector(-330.882400, -65.000000) * millimeter, vector(-450.000000, 0.000000) * millimeter, vector(-460.000000, -2.000000) * millimeter, vector(-460.000000, 198.000000) * millimeter, vector(-450.000000, 200.000000) * millimeter, vector(0.000000, 200.000000) * millimeter, vector(10.000000, 198.000000) * millimeter, vector(10.000000, -2.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1);
