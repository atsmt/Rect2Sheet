...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(-25.000000, -10.000000) * millimeter, vector(-25.000000, -18.000000) * millimeter, vector(85.000000, -18.000000) * millimeter, vector(85.000000, -10.000000) * millimeter, vector(80.000000, 0.000000) * millimeter, vector(80.000000, 80.000000) * millimeter, vector(0.000000, 80.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1);
        ...
        skPolyline(sketchRem3b, "polyRem3b", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(0.000000, -40.000000) * millimeter, vector(-2.000000, -50.000000) * millimeter, vector(78.000000, -50.000000) * millimeter, vector(80.000000, -40.000000) * millimeter, vector(80.000000, 70.000000) * millimeter, vector(-18.000000, 70.000000) * millimeter, vector(-18.000000, 0.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem3b);
