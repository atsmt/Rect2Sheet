...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(2.000000, -10.000000) * millimeter, vector(102.000000, -10.000000) * millimeter, vector(100.000000, 0.000000) * millimeter, vector(130.000000, -44.800000) * millimeter, vector(138.000000, -44.800000) * millimeter, vector(138.000000, 50.689655) * millimeter, vector(130.000000, 50.689655) * millimeter, vector(100.000000, 70.000000) * millimeter, vector(0.000000, 70.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2);
