...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem1b, "polyRem1b", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(70.000000, 0.000000) * millimeter, vector(80.000000, 2.000000) * millimeter, vector(80.000000, 102.000000) * millimeter, vector(70.000000, 100.000000) * millimeter, vector(70.000000, 108.000000) * millimeter, vector(0.000000, 108.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1b);
