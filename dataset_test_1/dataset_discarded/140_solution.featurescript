...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(51.322331, -10.000000) * millimeter, vector(51.322331, -18.000000) * millimeter, vector(133.809902, -18.000000) * millimeter, vector(133.809902, -10.000000) * millimeter, vector(180.000000, 0.000000) * millimeter, vector(180.000000, 100.000000) * millimeter, vector(148.189181, 110.000000) * millimeter, vector(148.189181, 118.000000) * millimeter, vector(7.700332, 118.000000) * millimeter, vector(7.700332, 110.000000) * millimeter, vector(0.000000, 100.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1);
