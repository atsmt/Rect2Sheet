...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem1_0_1a, "polyRem1_0_1a", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(8.000000, 0.000000) * millimeter, vector(8.000000, 100.000000) * millimeter, vector(0.000000, 100.000000) * millimeter, vector(-11.213805, 157.069262) * millimeter, vector(-2.143340, 164.140931) * millimeter, vector(-72.860038, 234.845589) * millimeter, vector(-81.930504, 227.773919) * millimeter, vector(0.000000, 0.000000) * millimeter] });
