...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(47.808997, -40.000000) * millimeter, vector(47.808997, -50.000000) * millimeter, vector(185.132233, -50.000000) * millimeter, vector(185.132233, -40.000000) * millimeter, vector(200.000000, 0.000000) * millimeter, vector(200.000000, 100.000000) * millimeter, vector(-10.000000, 100.000000) * millimeter, vector(-10.000000, 0.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(98.960707, 29.589324, 0.000000) * millimeter),
