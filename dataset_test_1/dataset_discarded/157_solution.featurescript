...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem1b, "polyRem1b", { "points" : [vector(-180.000000, 0.000000) * millimeter, vector(-180.000000, 100.000000) * millimeter, vector(-148.189181, 110.000000) * millimeter, vector(-146.189181, 120.000000) * millimeter, vector(-5.700332, 120.000000) * millimeter, vector(-7.700332, 110.000000) * millimeter, vector(0.000000, 100.000000) * millimeter, vector(8.000000, 100.000000) * millimeter, vector(8.000000, 0.000000) * millimeter, vector(-180.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1b);
