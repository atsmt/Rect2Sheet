...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem1b, "polyRem1b", { "points" : [vector(-180.000000, 0.000000) * millimeter, vector(-180.000000, 100.000000) * millimeter, vector(-173.839734, 110.000000) * millimeter, vector(-171.839734, 120.000000) * millimeter, vector(-37.763524, 120.000000) * millimeter, vector(-39.763524, 110.000000) * millimeter, vector(0.000000, 100.000000) * millimeter, vector(8.000000, 100.000000) * millimeter, vector(8.000000, 0.000000) * millimeter, vector(-180.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1b);
