...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem1b, "polyRem1b", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(0.000000, -8.000000) * millimeter, vector(70.000000, -8.000000) * millimeter, vector(70.000000, 100.000000) * millimeter, vector(0.000000, 100.000000) * millimeter, vector(-20.000000, 73.529400) * millimeter, vector(-30.000000, 71.529400) * millimeter, vector(-30.000000, 24.470600) * millimeter, vector(-20.000000, 26.470600) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1b);
