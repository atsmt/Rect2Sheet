...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(0.000000, -38.000000) * millimeter, vector(70.000000, -38.000000) * millimeter, vector(70.000000, 100.000000) * millimeter, vector(0.000000, 100.000000) * millimeter, vector(-20.000000, 73.529412) * millimeter, vector(-30.000000, 71.529412) * millimeter, vector(-30.000000, 24.470588) * millimeter, vector(-20.000000, 26.470588) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1);
