...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem1b, "polyRem1b", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(208.000000, 0.000000) * millimeter, vector(208.000000, 100.000000) * millimeter, vector(180.000000, 100.000000) * millimeter, vector(116.378362, 110.000000) * millimeter, vector(118.378362, 120.000000) * millimeter, vector(41.763524, 120.000000) * millimeter, vector(39.763524, 110.000000) * millimeter, vector(0.000000, 100.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1b);
