...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem2b, "polyRem2b", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(108.000000, 0.000000) * millimeter, vector(108.000000, 200.000000) * millimeter, vector(0.000000, 200.000000) * millimeter, vector(-48.189181, -20.000000) * millimeter, vector(-46.189181, -30.000000) * millimeter, vector(94.299668, -30.000000) * millimeter, vector(92.299668, -20.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2b);
