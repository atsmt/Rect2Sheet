...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        var wallFace1_1_2a = qClosestTo(qCreatedBy(id + "flange1_1_1_2a", EntityType.FACE), vector(-24.472146, -12.236048, -90.000000) * millimeter);
        var faceN1_1_2a = evPlane(context, { "face" : wallFace1_1_2a }).normal;
        var skN1_1_2a = dot(faceN1_1_2a, vector(0.4472095955, -0.894429191, 0.0)) >= 0 ? faceN1_1_2a : -faceN1_1_2a;
        var sketchRem1_1_2a = newSketchOnPlane(context, id + "sketchRem1_1_2a", { "sketchPlane" : plane(vector(-28.9443, -14.4721, -140.0) * millimeter, skN1_1_2a, vector(0.894429191, 0.4472095955, 0.0)) });
        skPolyline(sketchRem1_1_2a, "polyRem1_1_2a", { "points" : [vector(8.000009, 0.000000) * millimeter, vector(8.000009, 100.000000) * millimeter, vector(-32.721351, 100.000000) * millimeter, vector(-32.721351, 0.000000) * millimeter, vector(8.000009, 0.000000) * millimeter] });
        skSolve(sketchRem1_1_2a);
        sheetMetalTab(context, id + "smTab1_1_2a", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem1_1_2a"), vector(-24.472146, -12.236048, -140.000000) * millimeter),
