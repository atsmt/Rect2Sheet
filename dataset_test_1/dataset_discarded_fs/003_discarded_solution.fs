...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(82.800000, -20.000000) * millimeter, vector(82.800000, -30.000000) * millimeter, vector(167.753800, -30.000000) * millimeter, vector(167.753800, -20.000000) * millimeter, vector(160.000000, 0.000000) * millimeter, vector(170.000000, 14.000000) * millimeter, vector(180.000000, 14.000000) * millimeter, vector(180.000000, 56.000000) * millimeter, vector(170.000000, 56.000000) * millimeter, vector(160.000000, 70.000000) * millimeter, vector(0.000000, 70.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(68.660708, 24.747453, 0.000000) * millimeter),
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(14.000000, -30.000000) * millimeter, vector(14.000000, -38.000000) * millimeter, vector(56.000000, -38.000000) * millimeter, vector(56.000000, -30.000000) * millimeter, vector(70.000000, 0.000000) * millimeter, vector(70.000000, 100.000000) * millimeter, vector(0.000000, 100.000000) * millimeter, vector(-20.000000, 88.088200) * millimeter, vector(-30.000000, 86.088200) * millimeter, vector(-30.000000, 24.470600) * millimeter, vector(-20.000000, 26.470600) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1);
