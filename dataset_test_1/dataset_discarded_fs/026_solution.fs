...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem1b, "polyRem1b", { "points" : [vector(70.000000, 0.000000) * millimeter, vector(70.000000, 100.000000) * millimeter, vector(-8.000000, 100.000000) * millimeter, vector(-8.000000, -0.000000) * millimeter, vector(-20.000000, 100.000000) * millimeter, vector(-32.000000, 100.000000) * millimeter, vector(-32.000000, 0.000000) * millimeter, vector(70.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1b);
