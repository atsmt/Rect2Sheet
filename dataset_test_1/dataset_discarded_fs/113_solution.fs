...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(133.809902, -40.000000) * millimeter, vector(133.809902, -50.000000) * millimeter, vector(194.687889, -50.000000) * millimeter, vector(194.687889, -40.000000) * millimeter, vector(200.000000, 0.000000) * millimeter, vector(200.000000, 100.000000) * millimeter, vector(-10.000000, 100.000000) * millimeter, vector(-10.000000, 0.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(102.681315, 34.921026, 0.000000) * millimeter),
