...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(-62.193716, -131.259894) * millimeter, vector(-62.193716, -139.259894) * millimeter, vector(92.438743, -139.259894) * millimeter, vector(92.438743, -131.259894) * millimeter, vector(80.000000, 0.000000) * millimeter, vector(80.000000, 200.000000) * millimeter, vector(8.522728, 224.681599) * millimeter, vector(-0.929604, 225.945556) * millimeter, vector(-71.156331, 22.570776) * millimeter, vector(-61.703999, 21.306820) * millimeter, vector(0.000000, 200.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2);
