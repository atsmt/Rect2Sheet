...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        var wallFace1_0_1a = qClosestTo(qCreatedBy(id + "flange0_1_0_1a", EntityType.FACE), vector(210.003439, 59.000000, -4.584075) * millimeter);
        ...
        var sketchRem1_0_1a = newSketchOnPlane(context, id + "sketchRem1_0_1a", { "sketchPlane" : plane(vector(208.0069, 0.0, -9.1681) * millimeter, skN1_0_1a, vector(0.3993121858, 0.0, 0.9168150186)) });
        skPolyline(sketchRem1_0_1a, "polyRem1_0_1a", { "points" : [vector(7.999945, 0.000000) * millimeter, vector(7.999945, 118.000000) * millimeter, vector(-224.393571, 118.000000) * millimeter, vector(-224.393571, 0.000000) * millimeter, vector(7.999945, 0.000000) * millimeter] });
        skSolve(sketchRem1_0_1a);
        sheetMetalTab(context, id + "smTab1_0_1a", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem1_0_1a"), vector(210.003439, 0.000000, -4.584075) * millimeter),
            "booleanUnionScope" : wallFace1_0_1a,
            "booleanOffset" : 0.0 * millimeter
        });
        // Flange 1_0_1->1: bend=66.46deg, zone=10mm
        sheetMetalFlange(context, id + "flange1_0_1_1b", {
            "edges" : qClosestTo(qOwnedByBody(qBodyType(qCreatedBy(id + "smStart0", EntityType.BODY), BodyType.SOLID), EntityType.EDGE), vector(117.604900, 59.000000, -216.729000) * millimeter),
            "angleControlType" : SMFlangeAngleControlType.BEND_ANGLE,
        ...
        var wallFace1b = qClosestTo(qCreatedBy(id + "flange1_0_1_1b", EntityType.FACE), vector(114.199412, 59.000000, -213.068037) * millimeter);
        ...
        skPolyline(sketchRem1b, "polyRem1b", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(118.000000, 0.000000) * millimeter, vector(118.000000, 209.999977) * millimeter, vector(0.000000, 209.999977) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1b);
        sheetMetalTab(context, id + "smTab1b", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem1b"), vector(-26.787774, 59.000000, -61.504176) * millimeter),
