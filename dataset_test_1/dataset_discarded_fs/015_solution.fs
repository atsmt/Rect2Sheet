...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(82.800000, -20.000000) * millimeter, vector(82.800000, -30.000000) * millimeter, vector(210.400000, -30.000000) * millimeter, vector(210.400000, -20.000000) * millimeter, vector(160.000000, 0.000000) * millimeter, vector(160.000000, 70.000000) * millimeter, vector(-10.000000, 70.000000) * millimeter, vector(-10.000000, 0.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(72.670321, 22.235235, 0.000000) * millimeter),
