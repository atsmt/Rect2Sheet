...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(0.000000, 200.000000) * millimeter, vector(80.000000, 200.000000) * millimeter, vector(96.816545, -131.259894) * millimeter, vector(96.816545, -139.259894) * millimeter, vector(-31.948688, -139.259894) * millimeter, vector(-31.948688, -131.259894) * millimeter, vector(69.765463, -12.000000) * millimeter, vector(0.000000, -12.000000) * millimeter, vector(0.000000, 200.000000) * millimeter] });
        skSolve(sketchRem2);
