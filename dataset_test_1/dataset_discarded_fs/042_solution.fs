...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem2, "polyRem2", { "points" : [vector(100.000000, 0.000000) * millimeter, vector(130.000000, -147.200000) * millimeter, vector(138.000000, -147.200000) * millimeter, vector(138.000000, -19.600000) * millimeter, vector(130.000000, -19.600000) * millimeter, vector(100.000000, 70.000000) * millimeter, vector(-8.000000, 70.000000) * millimeter, vector(-8.000000, 0.000000) * millimeter, vector(100.000000, 0.000000) * millimeter] });
        skSolve(sketchRem2);
