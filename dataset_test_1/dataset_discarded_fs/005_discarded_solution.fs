...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(14.000000, -30.000000) * millimeter, vector(14.000000, -38.000000) * millimeter, vector(56.000000, -38.000000) * millimeter, vector(56.000000, -30.000000) * millimeter, vector(70.000000, 0.000000) * millimeter, vector(80.000000, -2.000000) * millimeter, vector(80.000000, 98.000000) * millimeter, vector(70.000000, 100.000000) * millimeter, vector(0.000000, 100.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1);
        ...
        var wallFace1_1_2a = qClosestTo(qCreatedBy(id + "flange1_1_1_2a", EntityType.FACE), vector(-23.816945, 76.770304, -90.000000) * millimeter);
        var faceN1_1_2a = evPlane(context, { "face" : wallFace1_1_2a }).normal;
        var skN1_1_2a = dot(faceN1_1_2a, vector(-0.6459391035, 0.7633889405, 0.0)) >= 0 ? faceN1_1_2a : -faceN1_1_2a;
        var sketchRem1_1_2a = newSketchOnPlane(context, id + "sketchRem1_1_2a", { "sketchPlane" : plane(vector(-27.6339, 73.5406, -40.0) * millimeter, skN1_1_2a, vector(0.7633889405, 0.6459391035, 0.0)) });
        skPolyline(sketchRem1_1_2a, "polyRem1_1_2a", { "points" : [vector(8.000014, 0.000000) * millimeter, vector(8.000014, 100.000000) * millimeter, vector(-158.293850, 100.000000) * millimeter, vector(-158.293850, 0.000000) * millimeter, vector(8.000014, 0.000000) * millimeter] });
        skSolve(sketchRem1_1_2a);
        sheetMetalTab(context, id + "smTab1_1_2a", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem1_1_2a"), vector(-23.816945, 76.770304, -40.000000) * millimeter),
