...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketch0, "poly0", { "points" : [vector(0.000000, -10.000000) * millimeter, vector(160.000000, -10.000000) * millimeter, vector(160.000000, 0.000000) * millimeter, vector(185.200000, -20.000000) * millimeter, vector(185.200000, -30.000000) * millimeter, vector(280.689655, -30.000000) * millimeter, vector(280.689655, -20.000000) * millimeter, vector(160.000000, 70.000000) * millimeter, vector(0.000000, 70.000000) * millimeter, vector(0.000000, -10.000000) * millimeter] });
        skSolve(sketch0);
        opExtractSurface(context, id + "surf0", {
            "faces" : qContainsPoint(qSketchRegion(id + "sketch0"), vector(38.976171, 22.066096, 0.000000) * millimeter),
