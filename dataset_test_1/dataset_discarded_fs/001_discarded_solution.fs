...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(70.000000, 0.000000) * millimeter, vector(70.000000, 110.000000) * millimeter, vector(0.000000, 110.000000) * millimeter, vector(0.000000, 100.000000) * millimeter, vector(-20.000000, 73.529400) * millimeter, vector(-30.000000, 73.529400) * millimeter, vector(-30.000000, 26.470600) * millimeter, vector(-20.000000, 26.470600) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1);
        sheetMetalTab(context, id + "smTab1", {
            "tabFaces" : qContainsPoint(qSketchRegion(id + "sketchRem1"), vector(-20.000000, 25.390484, -93.993289) * millimeter),
        ...
        skPolyline(sketchRem2_0, "polyRem2_0", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(-26.470600, -40.000000) * millimeter, vector(-26.470600, -48.000000) * millimeter, vector(-73.529400, -48.000000) * millimeter, vector(-73.529400, -40.000000) * millimeter, vector(-100.000000, 0.000000) * millimeter, vector(-100.000000, 30.000000) * millimeter, vector(0.000000, 30.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
