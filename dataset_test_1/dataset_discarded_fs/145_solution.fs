...
export const smPart = defineFeature(function(context is Context, id is Id, definition is map)
    precondition { }
    {
        ...
        skPolyline(sketchRem1, "polyRem1", { "points" : [vector(0.000000, 0.000000) * millimeter, vector(180.000000, 0.000000) * millimeter, vector(47.808997, -10.000000) * millimeter, vector(47.808997, -18.000000) * millimeter, vector(185.132233, -18.000000) * millimeter, vector(185.132233, -10.000000) * millimeter, vector(180.000000, 100.000000) * millimeter, vector(116.378362, 110.000000) * millimeter, vector(116.378362, 118.000000) * millimeter, vector(39.763524, 118.000000) * millimeter, vector(39.763524, 110.000000) * millimeter, vector(0.000000, 100.000000) * millimeter, vector(0.000000, 0.000000) * millimeter] });
        skSolve(sketchRem1);
